...
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mclear_hwcap;
#define x_VAR_mclear_hwcap do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mimpure_text;
#define x_VAR_mimpure_text do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mpc32;
...
enum opt_code
{
  ...
  /* OPT_ftail_call_workaround = 1030, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1031,         /* -ftail-call-workaround= */
  ...
  OPT_ftest_forall_temp = 1037,              /* -ftest-forall-temp */
  ...
  OPT_ftime_report_details = 1042,           /* -ftime-report-details */
  OPT_ftls_model_ = 1043,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1044,              /* -ftoplevel-reorder */
  OPT_ftracer = 1045,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1046,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1047,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1048,                   /* -ftrampolines */
  OPT_ftrapping_math = 1049,                 /* -ftrapping-math */
  OPT_ftrapv = 1050,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1051,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1052,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1053,                      /* -ftree-ccp */
  OPT_ftree_ch = 1054,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1055, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1056,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1057,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1058, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1059,                   /* -ftree-cselim */
  OPT_ftree_dce = 1060,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1061,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1062,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1063,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1064,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1065, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1066,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1067,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1068, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1069,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1070,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1071, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1072,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1073,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1074,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1075,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1076,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1077,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1078,                      /* -ftree-pre */
  OPT_ftree_pta = 1079,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1080,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1081, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1082,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1083,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1084,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1085,                     /* -ftree-slsr */
  OPT_ftree_sra = 1086,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1087, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1088, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1089,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1090,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1091,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1092, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1093,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1094, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1095,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1096,         /* -funconstrained-commons */
  OPT_funderscoring = 1097,                  /* -funderscoring */
  OPT_funit_at_a_time = 1098,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1099,              /* -funroll-all-loops */
  OPT_funroll_loops = 1100,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1101, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1102,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1103,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1104,                 /* -funsigned-char */
  OPT_funswitch_loops = 1105,                /* -funswitch-loops */
  OPT_funwind_tables = 1106,                 /* -funwind-tables */
  ...
  OPT_fwrapv_pointer = 1139,                 /* -fwrapv-pointer */
  ...
  OPT_mcld = 1242,                           /* -mcld */
  OPT_mclear_hwcap = 1243,                   /* -mclear-hwcap */
  ...
  OPT_mimpure_text = 1272,                   /* -mimpure-text */
  ...
  OPT_mvaes = 1357,                          /* -mvaes */
  OPT_mveclibabi_ = 1358,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1359,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1360,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1361,                    /* -mvzeroupper */
  OPT_mwbnoinvd = 1362,                      /* -mwbnoinvd */
  OPT_mx32 = 1363,                           /* -mx32 */
  OPT_mxop = 1364,                           /* -mxop */
  OPT_mxsave = 1365,                         /* -mxsave */
  OPT_mxsavec = 1366,                        /* -mxsavec */
  OPT_mxsaveopt = 1367,                      /* -mxsaveopt */
  OPT_mxsaves = 1368,                        /* -mxsaves */
  OPT_n = 1369,                              /* -n */
  OPT_no_canonical_prefixes = 1370,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1371,              /* -no-integrated-cpp */
  OPT_no_pie = 1372,                         /* -no-pie */
  OPT_nocpp = 1373,                          /* -nocpp */
  OPT_nodefaultlibs = 1374,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1375,                   /* -nostartfiles */
  OPT_nostdinc = 1376,                       /* -nostdinc */
  OPT_nostdinc__ = 1377,                     /* -nostdinc++ */
  OPT_nostdlib = 1378,                       /* -nostdlib */
  OPT_o = 1379,                              /* -o */
  OPT_p = 1380,                              /* -p */
  OPT_pass_exit_codes = 1381,                /* -pass-exit-codes */
  /* OPT_pedantic = 1382, */                 /* -pedantic */
  OPT_pedantic_errors = 1383,                /* -pedantic-errors */
  OPT_pg = 1384,                             /* -pg */
  OPT_pie = 1385,                            /* -pie */
  OPT_pipe = 1386,                           /* -pipe */
  ...
  /* OPT_specs = 1409, */                    /* -specs */
  OPT_specs_ = 1410,                         /* -specs= */
  OPT_static = 1411,                         /* -static */
  OPT_static_libasan = 1412,                 /* -static-libasan */
  OPT_static_libgcc = 1413,                  /* -static-libgcc */
  OPT_static_libgfortran = 1414,             /* -static-libgfortran */
  OPT_static_libgo = 1415,                   /* -static-libgo */
  OPT_static_liblsan = 1416,                 /* -static-liblsan */
  OPT_static_libmpx = 1417,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1418,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1419,               /* -static-libstdc++ */
  OPT_static_libtsan = 1420,                 /* -static-libtsan */
  OPT_static_libubsan = 1421,                /* -static-libubsan */
  OPT_static_pie = 1422,                     /* -static-pie */
  /* OPT_std_c__03 = 1423, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1424, */                /* -std=c++0x */
  OPT_std_c__11 = 1425,                      /* -std=c++11 */
  OPT_std_c__14 = 1426,                      /* -std=c++14 */
  OPT_std_c__17 = 1427,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1428, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1429, */                /* -std=c++1z */
  OPT_std_c__2a = 1430,                      /* -std=c++2a */
  OPT_std_c__98 = 1431,                      /* -std=c++98 */
  OPT_std_c11 = 1432,                        /* -std=c11 */
  OPT_std_c17 = 1433,                        /* -std=c17 */
  /* OPT_std_c18 = 1434, */                  /* -std=c18 */
  /* OPT_std_c1x = 1435, */                  /* -std=c1x */
  /* OPT_std_c89 = 1436, */                  /* -std=c89 */
  OPT_std_c90 = 1437,                        /* -std=c90 */
  OPT_std_c99 = 1438,                        /* -std=c99 */
  /* OPT_std_c9x = 1439, */                  /* -std=c9x */
  OPT_std_f2003 = 1440,                      /* -std=f2003 */
  OPT_std_f2008 = 1441,                      /* -std=f2008 */
  OPT_std_f2008ts = 1442,                    /* -std=f2008ts */
  OPT_std_f2018 = 1443,                      /* -std=f2018 */
  OPT_std_f95 = 1444,                        /* -std=f95 */
  OPT_std_gnu = 1445,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1446, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1447, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1448,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1449,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1450,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1451, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1452, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1453,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1454,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1455,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1456,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1457, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1458, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1459, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1460,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1461,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1462, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1463, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1464,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1465, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1466, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1467, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1468, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1469, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1470,                     /* -std=legacy */
  OPT_symbolic = 1471,                       /* -symbolic */
  OPT_t = 1472,                              /* -t */
  OPT_time = 1473,                           /* -time */
  OPT_time_ = 1474,                          /* -time= */
  OPT_traditional = 1475,                    /* -traditional */
  OPT_traditional_cpp = 1476,                /* -traditional-cpp */
  OPT_trigraphs = 1477,                      /* -trigraphs */
  OPT_u = 1478,                              /* -u */
  OPT_undef = 1479,                          /* -undef */
  OPT_v = 1480,                              /* -v */
  OPT_version = 1481,                        /* -version */
  OPT_w = 1482,                              /* -w */
  OPT_wrapper = 1483,                        /* -wrapper */
  OPT_x = 1484,                              /* -x */
  OPT_z = 1485,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
