...
enum opt_code
{
  ...
  OPT_mcmodel_ = 1221,                       /* -mcmodel= */
  OPT_mcmpb = 1222,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1223,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1224,                          /* -mcpu= */
  OPT_mcrypto = 1225,                        /* -mcrypto */
  OPT_mdebug_ = 1226,                        /* -mdebug= */
  /* OPT_mdirect_move = 1227, */             /* -mdirect-move */
  OPT_mdlmzb = 1228,                         /* -mdlmzb */
  OPT_mdouble_float = 1229,                  /* -mdouble-float */
  OPT_meabi = 1230,                          /* -meabi */
  OPT_mefficient_unaligned_vsx = 1231,       /* -mefficient-unaligned-vsx */
  OPT_memb = 1232,                           /* -memb */
  OPT_mfloat128 = 1233,                      /* -mfloat128 */
  OPT_mfloat128_convert = 1234,              /* -mfloat128-convert */
  OPT_mfloat128_hardware = 1235,             /* -mfloat128-hardware */
  OPT_mfold_gimple = 1236,                   /* -mfold-gimple */
  OPT_mfp_in_toc = 1237,                     /* -mfp-in-toc */
  OPT_mfprnd = 1238,                         /* -mfprnd */
  OPT_mfpu_ = 1239,                          /* -mfpu= */
  OPT_mfriz = 1240,                          /* -mfriz */
  OPT_mfull_toc = 1241,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1242, */              /* -mfused-madd */
  /* OPT_mgen_cell_microcode = 1243, */      /* -mgen-cell-microcode */
  OPT_mglibc = 1244,                         /* -mglibc */
  OPT_mgnu_attribute = 1245,                 /* -mgnu-attribute */
  OPT_mhard_dfp = 1246,                      /* -mhard-dfp */
  OPT_mhard_float = 1247,                    /* -mhard-float */
  OPT_mhtm = 1248,                           /* -mhtm */
  OPT_minsert_sched_nops_ = 1249,            /* -minsert-sched-nops= */
  OPT_misel = 1250,                          /* -misel */
  /* OPT_misel_no = 1251, */                 /* -misel=no */
  /* OPT_misel_yes = 1252, */                /* -misel=yes */
  OPT_mlittle = 1253,                        /* -mlittle */
  OPT_mlittle_endian = 1254,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1255,                  /* -mlong-double- */
  OPT_mlongcall = 1256,                      /* -mlongcall */
  /* OPT_mlra = 1257, */                     /* -mlra */
  OPT_mmfcrf = 1258,                         /* -mmfcrf */
  OPT_mmfpgpr = 1259,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1260,                   /* -mminimal-toc */
  OPT_mmodulo = 1261,                        /* -mmodulo */
  OPT_mmulhw = 1262,                         /* -mmulhw */
  OPT_mmultiple = 1263,                      /* -mmultiple */
  OPT_mmusl = 1264,                          /* -mmusl */
  OPT_mmvme = 1265,                          /* -mmvme */
  OPT_mnewlib = 1266,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1267,                  /* -mno-fp-in-toc */
  /* OPT_mno_string = 1268, */               /* -mno-string */
  OPT_mno_sum_in_toc = 1269,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1270,                        /* -mno-toc */
  OPT_mno_traceback = 1271,                  /* -mno-traceback */
  OPT_mno_update = 1272,                     /* -mno-update */
  OPT_moptimize_swaps = 1273,                /* -moptimize-swaps */
  OPT_mpaired = 1274,                        /* -mpaired */
  OPT_mpointers_to_nested_functions = 1275,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1276,                       /* -mpopcntb */
  OPT_mpopcntd = 1277,                       /* -mpopcntd */
  OPT_mpower8_fusion = 1278,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1279,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1280,                 /* -mpower8-vector */
  OPT_mpower9_fusion = 1281,                 /* -mpower9-fusion */
  OPT_mpower9_minmax = 1282,                 /* -mpower9-minmax */
  OPT_mpower9_misc = 1283,                   /* -mpower9-misc */
  OPT_mpower9_vector = 1284,                 /* -mpower9-vector */
  /* OPT_mpowerpc = 1285, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1286,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1287,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1288,                     /* -mpowerpc64 */
  OPT_mprioritize_restricted_insns_ = 1289,  /* -mprioritize-restricted-insns= */
  OPT_mprofile_kernel = 1290,                /* -mprofile-kernel */
  OPT_mprototype = 1291,                     /* -mprototype */
  OPT_mquad_memory = 1292,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1293,            /* -mquad-memory-atomic */
  OPT_mreadonly_in_sdata = 1294,             /* -mreadonly-in-sdata */
  OPT_mrecip = 1295,                         /* -mrecip */
  OPT_mrecip_precision = 1296,               /* -mrecip-precision */
  OPT_mrecip_ = 1297,                        /* -mrecip= */
  OPT_mregnames = 1298,                      /* -mregnames */
  OPT_mrelocatable = 1299,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 1300,               /* -mrelocatable-lib */
  OPT_msave_toc_indirect = 1301,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1302,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1303,                  /* -msched-epilog */
  OPT_msched_groups = 1304,                  /* -msched-groups */
  OPT_msched_prolog = 1305,                  /* -msched-prolog */
  OPT_msdata = 1306,                         /* -msdata */
  OPT_msdata_ = 1307,                        /* -msdata= */
  OPT_msecure_plt = 1308,                    /* -msecure-plt */
  OPT_mshlib = 1309,                         /* -mshlib */
  OPT_msim = 1310,                           /* -msim */
  OPT_msimple_fpu = 1311,                    /* -msimple-fpu */
  OPT_msingle_float = 1312,                  /* -msingle-float */
  OPT_msingle_pic_base = 1313,               /* -msingle-pic-base */
  OPT_msoft_float = 1314,                    /* -msoft-float */
  OPT_mspeculate_indirect_jumps = 1315,      /* -mspeculate-indirect-jumps */
  OPT_mstack_protector_guard_offset_ = 1316, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1317,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1318,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1319,                  /* -mstrict-align */
  OPT_mstring = 1320,                        /* -mstring */
  OPT_mstring_compare_inline_limit_ = 1321,  /* -mstring-compare-inline-limit= */
  OPT_msum_in_toc = 1322,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1323,            /* -msvr4-struct-return */
  OPT_mtls_markers = 1324,                   /* -mtls-markers */
  OPT_mtls_size_ = 1325,                     /* -mtls-size= */
  OPT_mtoc = 1326,                           /* -mtoc */
  OPT_mtoc_fusion = 1327,                    /* -mtoc-fusion */
  OPT_mtraceback_ = 1328,                    /* -mtraceback= */
  OPT_mtune_ = 1329,                         /* -mtune= */
  OPT_muclibc = 1330,                        /* -muclibc */
  OPT_mupdate = 1331,                        /* -mupdate */
  OPT_mveclibabi_ = 1332,                    /* -mveclibabi= */
  OPT_mvrsave = 1333,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1334, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1335, */              /* -mvrsave=yes */
  OPT_mvsx = 1336,                           /* -mvsx */
  OPT_mvsx_align_128 = 1337,                 /* -mvsx-align-128 */
  /* OPT_mvsx_timode = 1338, */              /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1339,             /* -mwarn-altivec-long */
  OPT_mxilinx_fpu = 1340,                    /* -mxilinx-fpu */
  OPT_mxl_compat = 1341,                     /* -mxl-compat */
  OPT_myellowknife = 1342,                   /* -myellowknife */
  OPT_n = 1343,                              /* -n */
  OPT_no_canonical_prefixes = 1344,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1345,              /* -no-integrated-cpp */
  OPT_no_pie = 1346,                         /* -no-pie */
  OPT_nocpp = 1347,                          /* -nocpp */
  OPT_nodefaultlibs = 1348,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1349,                   /* -nostartfiles */
  OPT_nostdinc = 1350,                       /* -nostdinc */
  OPT_nostdinc__ = 1351,                     /* -nostdinc++ */
  OPT_nostdlib = 1352,                       /* -nostdlib */
  OPT_o = 1353,                              /* -o */
  OPT_p = 1354,                              /* -p */
  OPT_pass_exit_codes = 1355,                /* -pass-exit-codes */
  /* OPT_pedantic = 1356, */                 /* -pedantic */
  OPT_pedantic_errors = 1357,                /* -pedantic-errors */
  OPT_pg = 1358,                             /* -pg */
  OPT_pie = 1359,                            /* -pie */
  OPT_pipe = 1360,                           /* -pipe */
  OPT_posix = 1361,                          /* -posix */
  OPT_print_file_name_ = 1362,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1363,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1364,          /* -print-multi-directory */
  OPT_print_multi_lib = 1365,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1366,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1367,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1368,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1369,               /* -print-prog-name= */
  OPT_print_search_dirs = 1370,              /* -print-search-dirs */
  OPT_print_sysroot = 1371,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1372,   /* -print-sysroot-headers-suffix */
  ...
  OPT_s = 1379,                              /* -s */
  OPT_save_temps = 1380,                     /* -save-temps */
  OPT_save_temps_ = 1381,                    /* -save-temps= */
  OPT_shared = 1382,                         /* -shared */
  OPT_shared_libgcc = 1383,                  /* -shared-libgcc */
  /* OPT_specs = 1384, */                    /* -specs */
  OPT_specs_ = 1385,                         /* -specs= */
  OPT_static = 1386,                         /* -static */
  OPT_static_libasan = 1387,                 /* -static-libasan */
  OPT_static_libgcc = 1388,                  /* -static-libgcc */
  OPT_static_libgfortran = 1389,             /* -static-libgfortran */
  OPT_static_libgo = 1390,                   /* -static-libgo */
  OPT_static_liblsan = 1391,                 /* -static-liblsan */
  OPT_static_libmpx = 1392,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1393,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1394,               /* -static-libstdc++ */
  OPT_static_libtsan = 1395,                 /* -static-libtsan */
  OPT_static_libubsan = 1396,                /* -static-libubsan */
  OPT_static_pie = 1397,                     /* -static-pie */
  /* OPT_std_c__03 = 1398, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1399, */                /* -std=c++0x */
  OPT_std_c__11 = 1400,                      /* -std=c++11 */
  OPT_std_c__14 = 1401,                      /* -std=c++14 */
  OPT_std_c__17 = 1402,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1403, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1404, */                /* -std=c++1z */
  OPT_std_c__2a = 1405,                      /* -std=c++2a */
  OPT_std_c__98 = 1406,                      /* -std=c++98 */
  OPT_std_c11 = 1407,                        /* -std=c11 */
  OPT_std_c17 = 1408,                        /* -std=c17 */
  /* OPT_std_c18 = 1409, */                  /* -std=c18 */
  /* OPT_std_c1x = 1410, */                  /* -std=c1x */
  /* OPT_std_c89 = 1411, */                  /* -std=c89 */
  OPT_std_c90 = 1412,                        /* -std=c90 */
  OPT_std_c99 = 1413,                        /* -std=c99 */
  /* OPT_std_c9x = 1414, */                  /* -std=c9x */
  OPT_std_f2003 = 1415,                      /* -std=f2003 */
  OPT_std_f2008 = 1416,                      /* -std=f2008 */
  OPT_std_f2008ts = 1417,                    /* -std=f2008ts */
  OPT_std_f2018 = 1418,                      /* -std=f2018 */
  OPT_std_f95 = 1419,                        /* -std=f95 */
  OPT_std_gnu = 1420,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1421, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1422, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1423,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1424,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1425,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1426, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1427, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1428,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1429,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1430,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1431,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1432, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1433, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1434, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1435,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1436,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1437, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1438, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1439,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1440, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1441, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1442, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1443, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1444, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1445,                     /* -std=legacy */
  OPT_symbolic = 1446,                       /* -symbolic */
  OPT_t = 1447,                              /* -t */
  OPT_time = 1448,                           /* -time */
  OPT_time_ = 1449,                          /* -time= */
  OPT_traditional = 1450,                    /* -traditional */
  OPT_traditional_cpp = 1451,                /* -traditional-cpp */
  OPT_trigraphs = 1452,                      /* -trigraphs */
  OPT_u = 1453,                              /* -u */
  OPT_undef = 1454,                          /* -undef */
  OPT_v = 1455,                              /* -v */
  OPT_version = 1456,                        /* -version */
  OPT_w = 1457,                              /* -w */
  OPT_wrapper = 1458,                        /* -wrapper */
  OPT_x = 1459,                              /* -x */
  OPT_z = 1460,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
