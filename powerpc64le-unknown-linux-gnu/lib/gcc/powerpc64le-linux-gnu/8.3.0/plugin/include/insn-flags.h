...
#define HAVE_bdz_di 1
#define HAVE_bdnz_di 1
#define HAVE_bdztf_di 1
#define HAVE_bdnztf_di 1
#define HAVE_trap 1
#define HAVE_prologue_movesi_from_cr 1
#define HAVE_stack_tie 1
#define HAVE_eh_set_lr_di 1
#define HAVE_prefetch 1
#define HAVE_load_split_stack_limit_di 1
...
#define HAVE_reload_pti_di_store 1
#define HAVE_reload_kf_di_store 1
#define HAVE_reload_if_di_store 1
#define HAVE_reload_tf_di_store 1
...
#define HAVE_reload_pti_di_load 1
#define HAVE_reload_kf_di_load 1
#define HAVE_reload_if_di_load 1
#define HAVE_reload_tf_di_load 1
...
#define HAVE_cstoredi4_signed 1
#define HAVE_cstoredi4_unsigned 1
...
static inline rtx gen_addsi3_carry                      (rtx, rtx, rtx);
static inline rtx
gen_addsi3_carry(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_subfsi3_carry                     (rtx, rtx, rtx);
static inline rtx
gen_subfsi3_carry(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_probe_stack_rangesi               (rtx, rtx, rtx, rtx);
static inline rtx
gen_probe_stack_rangesi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
...
static inline rtx gen_indirect_jumpsi_nospec            (rtx, rtx);
static inline rtx
gen_indirect_jumpsi_nospec(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
...
static inline rtx gen_bdz_si                            (rtx, rtx, rtx);
static inline rtx
gen_bdz_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_bdnz_si                           (rtx, rtx, rtx);
static inline rtx
gen_bdnz_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_bdz_di                            (rtx, rtx, rtx);
extern rtx        gen_bdnz_di                           (rtx, rtx, rtx);
static inline rtx gen_bdztf_si                          (rtx, rtx, rtx, rtx, rtx);
static inline rtx
gen_bdztf_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d), rtx ARG_UNUSED (e))
{
  return 0;
}
static inline rtx gen_bdnztf_si                         (rtx, rtx, rtx, rtx, rtx);
static inline rtx
gen_bdnztf_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d), rtx ARG_UNUSED (e))
{
  return 0;
}
...
static inline rtx gen_stack_restore_tie                 (rtx, rtx, rtx);
static inline rtx
gen_stack_restore_tie(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_load_split_stack_limit_si         (rtx);
static inline rtx
gen_load_split_stack_limit_si(rtx ARG_UNUSED (a))
{
  return 0;
}
...
static inline rtx gen_fusion_gpr_si_qi_load             (rtx, rtx, rtx);
static inline rtx
gen_fusion_gpr_si_qi_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_gpr_di_qi_load             (rtx, rtx, rtx);
static inline rtx gen_fusion_gpr_si_hi_load             (rtx, rtx, rtx);
static inline rtx
gen_fusion_gpr_si_hi_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_gpr_di_hi_load             (rtx, rtx, rtx);
static inline rtx gen_fusion_gpr_si_si_load             (rtx, rtx, rtx);
static inline rtx
gen_fusion_gpr_si_si_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_gpr_di_si_load             (rtx, rtx, rtx);
static inline rtx gen_fusion_gpr_si_di_load             (rtx, rtx, rtx);
static inline rtx
gen_fusion_gpr_si_di_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_gpr_di_di_load             (rtx, rtx, rtx);
static inline rtx gen_fusion_gpr_si_sf_load             (rtx, rtx, rtx);
static inline rtx
gen_fusion_gpr_si_sf_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_gpr_di_sf_load             (rtx, rtx, rtx);
static inline rtx gen_fusion_gpr_si_df_load             (rtx, rtx, rtx);
static inline rtx
gen_fusion_gpr_si_df_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_gpr_di_df_load             (rtx, rtx, rtx);
static inline rtx gen_fusion_gpr_si_qi_store            (rtx, rtx, rtx);
static inline rtx
gen_fusion_gpr_si_qi_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_gpr_di_qi_store            (rtx, rtx, rtx);
static inline rtx gen_fusion_gpr_si_hi_store            (rtx, rtx, rtx);
static inline rtx
gen_fusion_gpr_si_hi_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_gpr_di_hi_store            (rtx, rtx, rtx);
static inline rtx gen_fusion_gpr_si_si_store            (rtx, rtx, rtx);
static inline rtx
gen_fusion_gpr_si_si_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_gpr_di_si_store            (rtx, rtx, rtx);
static inline rtx gen_fusion_gpr_si_di_store            (rtx, rtx, rtx);
static inline rtx
gen_fusion_gpr_si_di_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_gpr_di_di_store            (rtx, rtx, rtx);
static inline rtx gen_fusion_gpr_si_sf_store            (rtx, rtx, rtx);
static inline rtx
gen_fusion_gpr_si_sf_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_gpr_di_sf_store            (rtx, rtx, rtx);
static inline rtx gen_fusion_gpr_si_df_store            (rtx, rtx, rtx);
static inline rtx
gen_fusion_gpr_si_df_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_gpr_di_df_store            (rtx, rtx, rtx);
static inline rtx gen_fusion_vsx_si_di_load             (rtx, rtx, rtx);
static inline rtx
gen_fusion_vsx_si_di_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_vsx_di_di_load             (rtx, rtx, rtx);
static inline rtx gen_fusion_vsx_si_sf_load             (rtx, rtx, rtx);
static inline rtx
gen_fusion_vsx_si_sf_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_vsx_di_sf_load             (rtx, rtx, rtx);
static inline rtx gen_fusion_vsx_si_df_load             (rtx, rtx, rtx);
static inline rtx
gen_fusion_vsx_si_df_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_vsx_di_df_load             (rtx, rtx, rtx);
static inline rtx gen_fusion_vsx_si_di_store            (rtx, rtx, rtx);
static inline rtx
gen_fusion_vsx_si_di_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_vsx_di_di_store            (rtx, rtx, rtx);
static inline rtx gen_fusion_vsx_si_sf_store            (rtx, rtx, rtx);
static inline rtx
gen_fusion_vsx_si_sf_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_fusion_vsx_di_sf_store            (rtx, rtx, rtx);
static inline rtx gen_fusion_vsx_si_df_store            (rtx, rtx, rtx);
static inline rtx
gen_fusion_vsx_si_df_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_altivec_lvx_v4si_2op_si           (rtx, rtx, rtx);
static inline rtx
gen_altivec_lvx_v4si_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v4si_2op_di           (rtx, rtx, rtx);
static inline rtx gen_altivec_lvx_v8hi_2op_si           (rtx, rtx, rtx);
static inline rtx
gen_altivec_lvx_v8hi_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v8hi_2op_di           (rtx, rtx, rtx);
static inline rtx gen_altivec_lvx_v16qi_2op_si          (rtx, rtx, rtx);
static inline rtx
gen_altivec_lvx_v16qi_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v16qi_2op_di          (rtx, rtx, rtx);
static inline rtx gen_altivec_lvx_v4sf_2op_si           (rtx, rtx, rtx);
static inline rtx
gen_altivec_lvx_v4sf_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v4sf_2op_di           (rtx, rtx, rtx);
static inline rtx gen_altivec_lvx_v2df_2op_si           (rtx, rtx, rtx);
static inline rtx
gen_altivec_lvx_v2df_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v2df_2op_di           (rtx, rtx, rtx);
static inline rtx gen_altivec_lvx_v2di_2op_si           (rtx, rtx, rtx);
static inline rtx
gen_altivec_lvx_v2di_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v2di_2op_di           (rtx, rtx, rtx);
static inline rtx gen_altivec_lvx_v1ti_2op_si           (rtx, rtx, rtx);
static inline rtx
gen_altivec_lvx_v1ti_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v1ti_2op_di           (rtx, rtx, rtx);
static inline rtx gen_altivec_lvx_kf_2op_si             (rtx, rtx, rtx);
static inline rtx
gen_altivec_lvx_kf_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_lvx_kf_2op_di             (rtx, rtx, rtx);
static inline rtx gen_altivec_lvx_tf_2op_si             (rtx, rtx, rtx);
static inline rtx
gen_altivec_lvx_tf_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_lvx_tf_2op_di             (rtx, rtx, rtx);
static inline rtx gen_altivec_lvx_v4si_1op_si           (rtx, rtx);
static inline rtx
gen_altivec_lvx_v4si_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v4si_1op_di           (rtx, rtx);
static inline rtx gen_altivec_lvx_v8hi_1op_si           (rtx, rtx);
static inline rtx
gen_altivec_lvx_v8hi_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v8hi_1op_di           (rtx, rtx);
static inline rtx gen_altivec_lvx_v16qi_1op_si          (rtx, rtx);
static inline rtx
gen_altivec_lvx_v16qi_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v16qi_1op_di          (rtx, rtx);
static inline rtx gen_altivec_lvx_v4sf_1op_si           (rtx, rtx);
static inline rtx
gen_altivec_lvx_v4sf_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v4sf_1op_di           (rtx, rtx);
static inline rtx gen_altivec_lvx_v2df_1op_si           (rtx, rtx);
static inline rtx
gen_altivec_lvx_v2df_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v2df_1op_di           (rtx, rtx);
static inline rtx gen_altivec_lvx_v2di_1op_si           (rtx, rtx);
static inline rtx
gen_altivec_lvx_v2di_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v2di_1op_di           (rtx, rtx);
static inline rtx gen_altivec_lvx_v1ti_1op_si           (rtx, rtx);
static inline rtx
gen_altivec_lvx_v1ti_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_lvx_v1ti_1op_di           (rtx, rtx);
static inline rtx gen_altivec_lvx_kf_1op_si             (rtx, rtx);
static inline rtx
gen_altivec_lvx_kf_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_lvx_kf_1op_di             (rtx, rtx);
static inline rtx gen_altivec_lvx_tf_1op_si             (rtx, rtx);
static inline rtx
gen_altivec_lvx_tf_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
...
static inline rtx gen_altivec_stvx_v4si_2op_si          (rtx, rtx, rtx);
static inline rtx
gen_altivec_stvx_v4si_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v4si_2op_di          (rtx, rtx, rtx);
static inline rtx gen_altivec_stvx_v8hi_2op_si          (rtx, rtx, rtx);
static inline rtx
gen_altivec_stvx_v8hi_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v8hi_2op_di          (rtx, rtx, rtx);
static inline rtx gen_altivec_stvx_v16qi_2op_si         (rtx, rtx, rtx);
static inline rtx
gen_altivec_stvx_v16qi_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v16qi_2op_di         (rtx, rtx, rtx);
static inline rtx gen_altivec_stvx_v4sf_2op_si          (rtx, rtx, rtx);
static inline rtx
gen_altivec_stvx_v4sf_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v4sf_2op_di          (rtx, rtx, rtx);
static inline rtx gen_altivec_stvx_v2df_2op_si          (rtx, rtx, rtx);
static inline rtx
gen_altivec_stvx_v2df_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v2df_2op_di          (rtx, rtx, rtx);
static inline rtx gen_altivec_stvx_v2di_2op_si          (rtx, rtx, rtx);
static inline rtx
gen_altivec_stvx_v2di_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v2di_2op_di          (rtx, rtx, rtx);
static inline rtx gen_altivec_stvx_v1ti_2op_si          (rtx, rtx, rtx);
static inline rtx
gen_altivec_stvx_v1ti_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v1ti_2op_di          (rtx, rtx, rtx);
static inline rtx gen_altivec_stvx_kf_2op_si            (rtx, rtx, rtx);
static inline rtx
gen_altivec_stvx_kf_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_stvx_kf_2op_di            (rtx, rtx, rtx);
static inline rtx gen_altivec_stvx_tf_2op_si            (rtx, rtx, rtx);
static inline rtx
gen_altivec_stvx_tf_2op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_altivec_stvx_tf_2op_di            (rtx, rtx, rtx);
static inline rtx gen_altivec_stvx_v4si_1op_si          (rtx, rtx);
static inline rtx
gen_altivec_stvx_v4si_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v4si_1op_di          (rtx, rtx);
static inline rtx gen_altivec_stvx_v8hi_1op_si          (rtx, rtx);
static inline rtx
gen_altivec_stvx_v8hi_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v8hi_1op_di          (rtx, rtx);
static inline rtx gen_altivec_stvx_v16qi_1op_si         (rtx, rtx);
static inline rtx
gen_altivec_stvx_v16qi_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v16qi_1op_di         (rtx, rtx);
static inline rtx gen_altivec_stvx_v4sf_1op_si          (rtx, rtx);
static inline rtx
gen_altivec_stvx_v4sf_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v4sf_1op_di          (rtx, rtx);
static inline rtx gen_altivec_stvx_v2df_1op_si          (rtx, rtx);
static inline rtx
gen_altivec_stvx_v2df_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v2df_1op_di          (rtx, rtx);
static inline rtx gen_altivec_stvx_v2di_1op_si          (rtx, rtx);
static inline rtx
gen_altivec_stvx_v2di_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v2di_1op_di          (rtx, rtx);
static inline rtx gen_altivec_stvx_v1ti_1op_si          (rtx, rtx);
static inline rtx
gen_altivec_stvx_v1ti_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_stvx_v1ti_1op_di          (rtx, rtx);
static inline rtx gen_altivec_stvx_kf_1op_si            (rtx, rtx);
static inline rtx
gen_altivec_stvx_kf_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
extern rtx        gen_altivec_stvx_kf_1op_di            (rtx, rtx);
static inline rtx gen_altivec_stvx_tf_1op_si            (rtx, rtx);
static inline rtx
gen_altivec_stvx_tf_1op_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
...
static inline rtx gen_reload_pti_si_store               (rtx, rtx, rtx);
static inline rtx
gen_reload_pti_si_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_reload_kf_si_store                (rtx, rtx, rtx);
static inline rtx
gen_reload_kf_si_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_reload_if_si_store                (rtx, rtx, rtx);
static inline rtx
gen_reload_if_si_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_reload_tf_si_store                (rtx, rtx, rtx);
static inline rtx
gen_reload_tf_si_store(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_reload_pti_si_load                (rtx, rtx, rtx);
static inline rtx
gen_reload_pti_si_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_reload_kf_si_load                 (rtx, rtx, rtx);
static inline rtx
gen_reload_kf_si_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_reload_if_si_load                 (rtx, rtx, rtx);
static inline rtx
gen_reload_if_si_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_reload_tf_si_load                 (rtx, rtx, rtx);
static inline rtx
gen_reload_tf_si_load(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_cstoresi4_signed                  (rtx, rtx, rtx, rtx);
static inline rtx
gen_cstoresi4_signed(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
extern rtx        gen_cstoredi4_signed                  (rtx, rtx, rtx, rtx);
static inline rtx gen_cstoresi4_unsigned                (rtx, rtx, rtx, rtx);
static inline rtx
gen_cstoresi4_unsigned(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
...
static inline rtx gen_nesi3                             (rtx, rtx, rtx);
static inline rtx
gen_nesi3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_tablejumpsi_nospec                (rtx, rtx, rtx);
static inline rtx
gen_tablejumpsi_nospec(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
