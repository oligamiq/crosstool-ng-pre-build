...
int sysevent_post_event(const char *event_class, const char *event_subclass,
	const char *vendor, const char *pub_name, nvlist_t *attr_list,
	sysevent_id_t *eid);
...
sysevent_t *sysevent_alloc_event(const char *event_class,
