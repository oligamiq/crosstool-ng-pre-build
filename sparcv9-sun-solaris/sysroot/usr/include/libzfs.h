...
#include <sys/param.h>
#include <sys/stat.h>	/* for getextmntent2 */
#include <sys/types.h>
...
_LIBZFS_H boolean_t zpool_is_bootable(zpool_handle_t *);
...
/* older interface for compatibility */
...
_LIBZFS_H int zfs_iter_snapshots(zfs_handle_t *, zfs_iter_f, void *);
...
_LIBZFS_H int zfs_iter_children2(zfs_handle_t *, int, zfs_iter_f, void *);
_LIBZFS_H int zfs_iter_dependents2(zfs_handle_t *, int, boolean_t, zfs_iter_f,
    void *);
_LIBZFS_H int zfs_iter_filesystems2(zfs_handle_t *, int, zfs_iter_f, void *);
_LIBZFS_H int zfs_iter_snapshots2(zfs_handle_t *, int, zfs_iter_f, void *,
    uint64_t, uint64_t);
_LIBZFS_H int zfs_iter_snapshots_sorted2(zfs_handle_t *, int, zfs_iter_f,
    void *, uint64_t, uint64_t);
_LIBZFS_H int zfs_iter_snapspec2(zfs_handle_t *, int, const char *, zfs_iter_f,
    void *);
_LIBZFS_H int zfs_iter_bookmarks2(zfs_handle_t *, int, zfs_iter_f, void *);
...
_LIBZFS_H int zfs_rename(zfs_handle_t *, const char *, boolean_t, boolean_t);
 ...
 */
_LIBZFS_H void libzfs_fru_refresh(libzfs_handle_t *);
_LIBZFS_H const char *libzfs_fru_lookup(libzfs_handle_t *, const char *);
_LIBZFS_H const char *libzfs_fru_devpath(libzfs_handle_t *, const char *);
_LIBZFS_H boolean_t libzfs_fru_compare(libzfs_handle_t *, const char *,
    const char *);
_LIBZFS_H boolean_t libzfs_fru_notself(libzfs_handle_t *, const char *);
_LIBZFS_H int zpool_fru_set(zpool_handle_t *, uint64_t, const char *);
...
_LIBZFS_H int zfs_init_libshare_arg(libzfs_handle_t *, int, void *);
/*
 ...
 */
_LIBZFS_H void zfs_uninit_libshare(libzfs_handle_t *);

_LIBZFS_H char *zfs_get_underlying_path(const char *);
_LIBZFS_H int getextmntent2(FILE *, const char *, struct extmnttab *,
    struct stat64 *);
