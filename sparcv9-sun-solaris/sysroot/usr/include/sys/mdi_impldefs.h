 ...
 */
struct pi_errs {
	kstat_named_t pi_softerrs;		/* "Soft" Error */
	kstat_named_t pi_harderrs;		/* "Hard" Error */
	kstat_named_t pi_transerrs;	/* Transport Errors */
	kstat_named_t pi_icnt_busy;	/* Interconnect Busy */
	kstat_named_t pi_icnt_errors;	/* Interconnect Errors */
	kstat_named_t pi_phci_rsrc;	/* pHCI No Resources */
	kstat_named_t pi_phci_localerr;	/* pHCI Local Errors */
	kstat_named_t pi_phci_invstate;	/* pHCI Invalid State */
	kstat_named_t pi_failedfrom;	/* Failover: Failed From */
	kstat_named_t pi_failedto;		/* Failover: Failed To */
};
