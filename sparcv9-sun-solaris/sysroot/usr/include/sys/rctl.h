...
struct kstat_s *rctl_kstat_create_zone(struct zone *, char *, uchar_t, uint_t,
    uchar_t);

struct kstat_s *rctl_kstat_create_project(struct kproject *, char *, uchar_t,
    uint_t, uchar_t);

struct kstat_s *rctl_kstat_create_task(struct task *, char *, uchar_t,
    uint_t, uchar_t);
