...
struct ecppkstat {
	 ...
	 * number of bytes, transferred in and out in each mode
	 */
	kstat_named_t	ek_ctx_obytes;
	kstat_named_t	ek_ctxpio_obytes;
	kstat_named_t	ek_nib_ibytes;
	kstat_named_t	ek_ecp_obytes;
	kstat_named_t	ek_ecp_ibytes;
	kstat_named_t	ek_epp_obytes;
	kstat_named_t	ek_epp_ibytes;
	kstat_named_t	ek_diag_obytes;
	/*
	 * number of transitions to particular mode
	 */
	kstat_named_t	ek_to_ctx;
	kstat_named_t	ek_to_nib;
	kstat_named_t	ek_to_ecp;
	kstat_named_t	ek_to_epp;
	kstat_named_t	ek_to_diag;
	/*
	 * other stats
	 */
	kstat_named_t	ek_xfer_tout;	/* # transfer timeouts */
	kstat_named_t	ek_ctx_cf;	/* # periph check failures */
	kstat_named_t	ek_joblen;	/* # bytes xfer'd since open */
	kstat_named_t	ek_isr_reattempt_high;	/* max # times */
							/* isr has looped */
	kstat_named_t	ek_mode;	/* 1284 mode */
	kstat_named_t	ek_phase;	/* 1284 ECP phase */
	kstat_named_t	ek_backchan;	/* backchannel mode supported */
	kstat_named_t	ek_iomode;	/* transfer mode: pio/dma */
	kstat_named_t	ek_state;	/* ecpp busy flag */
};
