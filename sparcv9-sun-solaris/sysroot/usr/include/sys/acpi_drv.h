...
typedef struct acpi_drv_power_kstat_s {
	kstat_named_t	acpi_drv_power;
	kstat_named_t	acpi_drv_supported_battery_count;
} acpi_drv_power_kstat_t;

typedef struct acpi_drv_warn_kstat_s {
	kstat_named_t	acpi_drv_bw_enabled;
	kstat_named_t	acpi_drv_bw_charge_warn;
	kstat_named_t	acpi_drv_bw_charge_low;
} acpi_drv_warn_kstat_t;

/* BIF kstat */
typedef struct acpi_drv_bif_kstat_s {
	kstat_named_t	acpi_drv_bif_unit;
	kstat_named_t	acpi_drv_bif_design_cap;
	kstat_named_t	acpi_drv_bif_last_cap;
	kstat_named_t	acpi_drv_bif_tech;
	kstat_named_t	acpi_drv_bif_voltage;
	kstat_named_t	acpi_drv_bif_warn_cap;
	kstat_named_t	acpi_drv_bif_low_cap;
	kstat_named_t	acpi_drv_bif_gran1_cap;
	kstat_named_t	acpi_drv_bif_gran2_cap;
	kstat_named_t	acpi_drv_bif_model;
	kstat_named_t	acpi_drv_bif_serial;
	kstat_named_t	acpi_drv_bif_type;
	kstat_named_t	acpi_drv_bif_oem_info;
} acpi_drv_bif_kstat_t;

/* BST kstat */
typedef struct acpi_drv_bst_kstat_s {
	kstat_named_t	acpi_drv_bst_state;
	kstat_named_t	acpi_drv_bst_rate;
	kstat_named_t	acpi_drv_bst_rem_cap;
	kstat_named_t	acpi_drv_bst_voltage;
