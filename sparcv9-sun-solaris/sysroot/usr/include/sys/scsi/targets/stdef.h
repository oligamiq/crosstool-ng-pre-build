...
struct scsi_tape {
	...
	kstat_t *un_stats;	/* for I/O statistics */
 ...
 */
struct st_errstats {
	kstat_named_t	st_softerrs;
	kstat_named_t	st_harderrs;
	kstat_named_t	st_transerrs;
	kstat_named_t	st_vid;
	kstat_named_t	st_pid;
	kstat_named_t	st_revision;
	kstat_named_t	st_serial;
};
