...
#define	SCSI_ADDR_PROP_ENCLOSURE	"scsi-enclosure"	/* string */
#define	SCSI_ADDR_PROP_SLOT		"scsi-slot"	/* string */
#define	SCSI_ADDR_PROP_PORT_WWN		"port-wwn"	/* string */
#define	SCSI_ADDR_PROP_SCSI_WWN		"scsi-wwn"	/* string */
