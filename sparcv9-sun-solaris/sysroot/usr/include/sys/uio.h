...
#define	zfs_uio_offset(uio)		(uio)->uio_offset
...
#define	zfs_uio_fault_move(p, n, rw, u)	uiomove((p), (n), (rw), (u))
#define	zfs_uiomove(p, n, rw, u)	uiomove((p), (n), (rw), (u))
#define	zfs_uio_fault_disable(u, set)
#define	zfs_uiocopy(p, n, rw, u, b)	uiocopy((p), (n), (rw), (u), (b))
#define	zfs_uio_prefaultpages(size, u)	(0)
#define	zfs_uioskip(p, n)		uioskip((p), (n))

#define	zfs_uio_setoffset(uio, off) \
	do { \
		(uio)->uio_offset = (off); \
	} while (0)
