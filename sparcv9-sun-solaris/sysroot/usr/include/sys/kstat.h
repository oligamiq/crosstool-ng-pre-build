...
#if 0 /* FIXME: 255 is failed, move to use 31 */
...
typedef int kstat_snapshot_t(struct kstat_s *, void *, int);
...
struct kstat_s {
	 ...
	 */
	int		(*ks_update)(kstat_t *, int); /* dynamic update */
	void		*ks_private;	/* arbitrary provider-private data */
	int		(*ks_snapshot)(kstat_t *, void *, int);
	void		*ks_lock;	/* protects this kstat's data */
#if 0 /* FIXME - not implemented yet */
	/* from ZoL */
	void		*ks_private_lock;	/* kstat private data lock */
...
#if 0 /* FIXME - not implemented yet */
	/* from ZoL */
	caddr32_t	_ks_lock_private;
	kstat_raw_ops_t	ks_raw_ops;		/* ops table for raw type */
	char		*ks_raw_buf;		/* buf used for raw ops */
	size32_t	ks_raw_bufsize;		/* size of raw ops buffer */
/* #if 0  FIXME - not implemented yet */
	kstat_proc_entry_t	ks_proc;	/* data for procfs entry */
/* #endif */
	int		ks_magic;		/* magic value */
...
#define	KSTAT_DATA_LONG32	KSTAT_DATA_INT32
#define	KSTAT_DATA_ULONG	KSTAT_DATA_UINT32
#define	KSTAT_DATA_ULONG32	KSTAT_DATA_UINT32
#else
#if !defined(_KERNEL)
...
extern void kstat_named_setstr_alt(kstat_t *, kstat_named_t *, char *,
    size_t, char *);
extern void kstat_named_clrstr_alt(kstat_t *, kstat_named_t *);
