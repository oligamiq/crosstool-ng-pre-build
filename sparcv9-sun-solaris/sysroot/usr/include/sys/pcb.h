...
#define	_PCB_ASYNC_HWERR	0x20	/* asynchronous h/w error */
					/* (e.g. parity error) */
#define	_PCB_ASYNC_BERR	0x40	/* asynchronous bus error */
#define	_PCB_ASYNC_BTO	0x80	/* asynchronous bus timeout */
#define	_PCB_ASYNC_MOD_ILL	0x100	/* async module error w/ */
					/* illegal instr/cycle 	*/
#define	_PCB_ASYNC_MOD_SEGV	0x200	/* async module error w/ */
					/* address violation */
#define	_PCB_ASYNC_ERR	(_PCB_ASYNC_HWERR | _PCB_ASYNC_BERR | _PCB_ASYNC_BTO | \
			    _PCB_ASYNC_MOD_ILL | _PCB_ASYNC_MOD_SEGV)
