...
struct bd_errstats {
	...
	kstat_named_t	bd_hba;
	kstat_named_t	bd_ssd;
	kstat_named_t	bd_enclosure;
	kstat_named_t	bd_slot;
	kstat_named_t	bd_devid;
	kstat_named_t	bd_blksize;
	kstat_named_t	bd_sys_blksize;
	kstat_named_t	bd_wwn;
