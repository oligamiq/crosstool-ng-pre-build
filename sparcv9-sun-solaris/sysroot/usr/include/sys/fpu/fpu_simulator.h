...
struct fpustat_kstat  {
	kstat_named_t		fpu_ieee_traps;
	kstat_named_t		fpu_unfinished_traps;
	kstat_named_t		fpu_unimplemented_traps;
};

struct fpuinfo_kstat {
	kstat_named_t		fpu_sim_fmovs;
	kstat_named_t		fpu_sim_fmovd;
	kstat_named_t		fpu_sim_fmovq;
	kstat_named_t		fpu_sim_fnegs;
	kstat_named_t		fpu_sim_fnegd;
	kstat_named_t		fpu_sim_fnegq;
	kstat_named_t		fpu_sim_fabss;
	kstat_named_t		fpu_sim_fabsd;
	kstat_named_t		fpu_sim_fabsq;
	kstat_named_t		fpu_sim_fsqrts;
	kstat_named_t		fpu_sim_fsqrtd;
	kstat_named_t		fpu_sim_fsqrtq;
	kstat_named_t		fpu_sim_fadds;
	kstat_named_t		fpu_sim_faddd;
	kstat_named_t		fpu_sim_faddq;
	kstat_named_t		fpu_sim_fsubs;
	kstat_named_t		fpu_sim_fsubd;
	kstat_named_t		fpu_sim_fsubq;
	kstat_named_t		fpu_sim_fmuls;
	kstat_named_t		fpu_sim_fmuld;
	kstat_named_t		fpu_sim_fmulq;
	kstat_named_t		fpu_sim_fdivs;
	kstat_named_t		fpu_sim_fdivd;
	kstat_named_t		fpu_sim_fdivq;
	kstat_named_t		fpu_sim_fcmps;
	kstat_named_t		fpu_sim_fcmpd;
	kstat_named_t		fpu_sim_fcmpq;
	kstat_named_t		fpu_sim_fcmpes;
	kstat_named_t		fpu_sim_fcmped;
	kstat_named_t		fpu_sim_fcmpeq;
	kstat_named_t		fpu_sim_fsmuld;
	kstat_named_t		fpu_sim_fdmulx;
	kstat_named_t		fpu_sim_fstox;
	kstat_named_t		fpu_sim_fdtox;
	kstat_named_t		fpu_sim_fqtox;
	kstat_named_t		fpu_sim_fxtos;
	kstat_named_t		fpu_sim_fxtod;
	kstat_named_t		fpu_sim_fxtoq;
	kstat_named_t		fpu_sim_fitos;
	kstat_named_t		fpu_sim_fitod;
	kstat_named_t		fpu_sim_fitoq;
	kstat_named_t		fpu_sim_fstoi;
	kstat_named_t		fpu_sim_fdtoi;
	kstat_named_t		fpu_sim_fqtoi;
	kstat_named_t		fpu_sim_fmovcc;
	kstat_named_t		fpu_sim_fmovr;
	kstat_named_t		fpu_sim_fmadds;
	kstat_named_t		fpu_sim_fmaddd;
	kstat_named_t		fpu_sim_fmsubs;
	kstat_named_t		fpu_sim_fmsubd;
	kstat_named_t		fpu_sim_fnmadds;
	kstat_named_t		fpu_sim_fnmaddd;
	kstat_named_t		fpu_sim_fnmsubs;
	kstat_named_t		fpu_sim_fnmsubd;
	kstat_named_t		fpu_sim_invalid;
};

struct visinfo_kstat {
	kstat_named_t		vis_edge8;
	kstat_named_t		vis_edge8n;
	kstat_named_t		vis_edge8l;
	kstat_named_t		vis_edge8ln;
	kstat_named_t		vis_edge16;
	kstat_named_t		vis_edge16n;
	kstat_named_t		vis_edge16l;
	kstat_named_t		vis_edge16ln;
	kstat_named_t		vis_edge32;
	kstat_named_t		vis_edge32n;
	kstat_named_t		vis_edge32l;
	kstat_named_t		vis_edge32ln;
	kstat_named_t		vis_array8;
	kstat_named_t		vis_array16;
	kstat_named_t		vis_array32;
	kstat_named_t		vis_bmask;
	kstat_named_t		vis_fcmple16;
	kstat_named_t		vis_fcmpne16;
	kstat_named_t		vis_fcmpgt16;
	kstat_named_t		vis_fcmpeq16;
	kstat_named_t		vis_fcmple32;
	kstat_named_t		vis_fcmpne32;
	kstat_named_t		vis_fcmpgt32;
	kstat_named_t		vis_fcmpeq32;
	kstat_named_t		vis_fmul8x16;
	kstat_named_t		vis_fmul8x16au;
	kstat_named_t		vis_fmul8x16al;
	kstat_named_t		vis_fmul8sux16;
	kstat_named_t		vis_fmul8ulx16;
	kstat_named_t		vis_fmuld8sux16;
	kstat_named_t		vis_fmuld8ulx16;
	kstat_named_t		vis_fpack16;
	kstat_named_t		vis_fpack32;
	kstat_named_t		vis_fpackfix;
	kstat_named_t		vis_fexpand;
	kstat_named_t		vis_fpmerge;
	kstat_named_t		vis_pdist;
	kstat_named_t		vis_pdistn;
	kstat_named_t		vis_bshuffle;
};
