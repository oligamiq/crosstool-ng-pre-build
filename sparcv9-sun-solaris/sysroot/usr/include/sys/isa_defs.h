 ...
 *	This indicates that the architecture support efficient unaligned
 *	access.
 *
...
#if defined(__x86)
#define	BUILD_ARCH64	"amd64"
#elif defined(__sparc)
#define	BUILD_ARCH64	"sparcv9"
#else
#error "Platform not defined for BUILD_ARCH64!"
#endif /* __x86 */
#endif /* BUILD_ARCH64 */
