...
extern boolean_t zfs_prop_readonly(zfs_prop_t);
extern boolean_t zfs_prop_visible(zfs_prop_t prop);
extern boolean_t zfs_prop_inheritable(zfs_prop_t);
extern boolean_t zfs_prop_setonce(zfs_prop_t);
extern boolean_t zfs_prop_encryption_key_param(zfs_prop_t);
extern boolean_t zfs_prop_valid_keylocation(const char *, boolean_t);
extern const char *zfs_prop_to_name(zfs_prop_t);
extern zfs_prop_t zfs_name_to_prop(const char *);
extern boolean_t zfs_prop_user(const char *);
extern boolean_t zfs_prop_userquota(const char *);
extern boolean_t zfs_prop_written(const char *);
extern int zfs_prop_index_to_string(zfs_prop_t, uint64_t, const char **);
extern int zfs_prop_string_to_index(zfs_prop_t, const char *,
    uint64_t *);
extern uint64_t zfs_prop_random_value(zfs_prop_t, uint64_t seed);
extern boolean_t zfs_prop_valid_for_type(int, zfs_type_t, boolean_t);
...
extern boolean_t zpool_prop_readonly(zpool_prop_t);
extern boolean_t zpool_prop_setonce(zpool_prop_t);
extern boolean_t zpool_prop_feature(const char *);
extern boolean_t zpool_prop_unsupported(const char *);
extern int zpool_prop_index_to_string(zpool_prop_t, uint64_t,
    const char **);
extern int zpool_prop_string_to_index(zpool_prop_t, const char *,
    uint64_t *);
extern uint64_t zpool_prop_random_value(zpool_prop_t, uint64_t seed);

/*
 * VDEV property functions shared between libzfs and kernel.
 */
extern vdev_prop_t vdev_name_to_prop(const char *);
extern boolean_t vdev_prop_user(const char *name);
extern const char *vdev_prop_to_name(vdev_prop_t);
extern const char *vdev_prop_default_string(vdev_prop_t);
extern uint64_t vdev_prop_default_numeric(vdev_prop_t);
extern boolean_t vdev_prop_readonly(vdev_prop_t prop);
extern int vdev_prop_index_to_string(vdev_prop_t, uint64_t,
    const char **);
extern int vdev_prop_string_to_index(vdev_prop_t, const char *,
    uint64_t *);
extern boolean_t zpool_prop_vdev(const char *name);
extern uint64_t vdev_prop_random_value(vdev_prop_t prop, uint64_t seed);
...
#define	ZPOOL_CONFIG_PRODUCT_ID		"product_id"
#define	ZPOOL_CONFIG_VENDOR_ID		"vendor_id"
#define	ZPOOL_CONFIG_SERIAL_NO		"serial_no"
#define	ZPOOL_CONFIG_HBA		"hba"
#define	ZPOOL_CONFIG_ENCLOSURE		"enclosure"
#define	ZPOOL_CONFIG_SLOT		"slot"
 ...
 * FIXME: in open zfs SYSCONFDIR & PKGDATADIR are defined ountside
 */
#define	SYSCONFDIR		"/usr/share"
...
typedef enum {
	...
	SPA_LOAD_UNLOADING 	/* unloading in progress */
} spa_load_state_t;
 ...
 * sysevents.
 */
#define	ZFS_EV_POOL_NAME	FM_EREPORT_PAYLOAD_ZFS_POOL
#define	ZFS_EV_POOL_GUID	FM_EREPORT_PAYLOAD_ZFS_POOL_GUID
#define	ZFS_EV_VDEV_PATH	FM_EREPORT_PAYLOAD_ZFS_VDEV_PATH
#define	ZFS_EV_VDEV_GUID	FM_EREPORT_PAYLOAD_ZFS_VDEV_GUID
