/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../gcc-6.5.0/gcc/config/sparc/sparc.md'.  */
...
extern int noov_compare_operator (rtx, machine_mode);
extern int noov_compare64_operator (rtx, machine_mode);
extern int v9_register_compare_operator (rtx, machine_mode);
