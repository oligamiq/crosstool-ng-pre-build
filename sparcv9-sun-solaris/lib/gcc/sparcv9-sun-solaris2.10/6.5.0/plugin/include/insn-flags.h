...
#define HAVE_addx 1
#define HAVE_addxc (TARGET_ARCH64 && TARGET_VIS3)
...
#define HAVE_divdi3 (TARGET_ARCH64)
...
#define HAVE_udivdi3 (TARGET_ARCH64)
#define HAVE_anddi3 (TARGET_ARCH64)
#define HAVE_andsi3 1
#define HAVE_iordi3 (TARGET_ARCH64)
#define HAVE_iorsi3 1
#define HAVE_xordi3 (TARGET_ARCH64)
#define HAVE_xorsi3 1
#define HAVE_negsi2 1
#define HAVE_one_cmpldi2 (TARGET_ARCH64)
...
#define HAVE_update_return (! TARGET_ARCH64)
#define HAVE_nop 1
#define HAVE_flush_register_windows 1
#define HAVE_flushsi (Pmode == SImode)
#define HAVE_flushdi (Pmode == DImode)
...
#define HAVE_tgd_add32 (TARGET_TLS && TARGET_ARCH32)
#define HAVE_tgd_add64 (TARGET_TLS && TARGET_ARCH64)
#define HAVE_tgd_call32 (TARGET_TLS && TARGET_ARCH32)
#define HAVE_tgd_call64 (TARGET_TLS && TARGET_ARCH64)
#define HAVE_tldm_hi22 1
#define HAVE_tldm_lo10 1
#define HAVE_tldm_add32 (TARGET_TLS && TARGET_ARCH32)
#define HAVE_tldm_add64 (TARGET_TLS && TARGET_ARCH64)
#define HAVE_tldm_call32 (TARGET_TLS && TARGET_ARCH32)
#define HAVE_tldm_call64 (TARGET_TLS && TARGET_ARCH64)
#define HAVE_tldo_hix22 1
#define HAVE_tldo_lox10 1
#define HAVE_tldo_add32 (TARGET_TLS && TARGET_ARCH32)
#define HAVE_tldo_add64 (TARGET_TLS && TARGET_ARCH64)
#define HAVE_tie_hi22 1
#define HAVE_tie_lo10 1
#define HAVE_tie_ld32 (TARGET_TLS && TARGET_ARCH32)
#define HAVE_tie_ld64 (TARGET_TLS && TARGET_ARCH64)
#define HAVE_tle_hix22_sp32 (TARGET_TLS && TARGET_ARCH32)
#define HAVE_tle_lox10_sp32 (TARGET_TLS && TARGET_ARCH32)
#define HAVE_tle_hix22_sp64 (TARGET_TLS && TARGET_ARCH64)
#define HAVE_tle_lox10_sp64 (TARGET_TLS && TARGET_ARCH64)
#define HAVE_stack_protect_setsi (TARGET_ARCH32)
#define HAVE_stack_protect_setdi (TARGET_ARCH64)
#define HAVE_stack_protect_testsi (TARGET_ARCH32)
#define HAVE_stack_protect_testdi (TARGET_ARCH64)
...
#define HAVE_edge8di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_edge8lsi_vis ((TARGET_VIS) && (Pmode == SImode))
#define HAVE_edge8ldi_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_edge16si_vis ((TARGET_VIS) && (Pmode == SImode))
#define HAVE_edge16di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_edge16lsi_vis ((TARGET_VIS) && (Pmode == SImode))
#define HAVE_edge16ldi_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_edge32si_vis ((TARGET_VIS) && (Pmode == SImode))
#define HAVE_edge32di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_edge32lsi_vis ((TARGET_VIS) && (Pmode == SImode))
#define HAVE_edge32ldi_vis ((TARGET_VIS) && (Pmode == DImode))
...
#define HAVE_fcmple16di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_fcmpne16di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_fcmpgt16di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_fcmpeq16di_vis ((TARGET_VIS) && (Pmode == DImode))
...
#define HAVE_fcmple32di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_fcmpne32di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_fcmpgt32di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_fcmpeq32di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_fpcmple8si_vis ((TARGET_VIS4) && (Pmode == SImode))
#define HAVE_fpcmpne8si_vis ((TARGET_VIS4) && (Pmode == SImode))
#define HAVE_fpcmpgt8si_vis ((TARGET_VIS4) && (Pmode == SImode))
#define HAVE_fpcmpeq8si_vis ((TARGET_VIS4) && (Pmode == SImode))
#define HAVE_fpcmple8di_vis ((TARGET_VIS4) && (Pmode == DImode))
#define HAVE_fpcmpne8di_vis ((TARGET_VIS4) && (Pmode == DImode))
#define HAVE_fpcmpgt8di_vis ((TARGET_VIS4) && (Pmode == DImode))
#define HAVE_fpcmpeq8di_vis ((TARGET_VIS4) && (Pmode == DImode))
#define HAVE_array8si_vis ((TARGET_VIS) && (Pmode == SImode))
#define HAVE_array8di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_array16si_vis ((TARGET_VIS) && (Pmode == SImode))
#define HAVE_array16di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_array32si_vis ((TARGET_VIS) && (Pmode == SImode))
#define HAVE_array32di_vis ((TARGET_VIS) && (Pmode == DImode))
#define HAVE_bmaskdi_vis (TARGET_VIS2 && TARGET_ARCH64)
...
#define HAVE_edge8ndi_vis ((TARGET_VIS2) && (Pmode == DImode))
#define HAVE_edge8lnsi_vis ((TARGET_VIS2) && (Pmode == SImode))
#define HAVE_edge8lndi_vis ((TARGET_VIS2) && (Pmode == DImode))
#define HAVE_edge16nsi_vis ((TARGET_VIS2) && (Pmode == SImode))
#define HAVE_edge16ndi_vis ((TARGET_VIS2) && (Pmode == DImode))
#define HAVE_edge16lnsi_vis ((TARGET_VIS2) && (Pmode == SImode))
#define HAVE_edge16lndi_vis ((TARGET_VIS2) && (Pmode == DImode))
#define HAVE_edge32nsi_vis ((TARGET_VIS2) && (Pmode == SImode))
#define HAVE_edge32ndi_vis ((TARGET_VIS2) && (Pmode == DImode))
#define HAVE_edge32lnsi_vis ((TARGET_VIS2) && (Pmode == SImode))
#define HAVE_edge32lndi_vis ((TARGET_VIS2) && (Pmode == DImode))
#define HAVE_cmask8si_vis ((TARGET_VIS3) && (Pmode == SImode))
#define HAVE_cmask8di_vis ((TARGET_VIS3) && (Pmode == DImode))
#define HAVE_cmask16si_vis ((TARGET_VIS3) && (Pmode == SImode))
#define HAVE_cmask16di_vis ((TARGET_VIS3) && (Pmode == DImode))
#define HAVE_cmask32si_vis ((TARGET_VIS3) && (Pmode == SImode))
#define HAVE_cmask32di_vis ((TARGET_VIS3) && (Pmode == DImode))
...
#define HAVE_pdistndi_vis ((TARGET_VIS3) && (Pmode == DImode))
...
#define HAVE_fucmple8di_vis ((TARGET_VIS3) && (Pmode == DImode))
#define HAVE_fucmpne8di_vis ((TARGET_VIS3) && (Pmode == DImode))
#define HAVE_fucmpgt8di_vis ((TARGET_VIS3) && (Pmode == DImode))
#define HAVE_fucmpeq8di_vis ((TARGET_VIS3) && (Pmode == DImode))
#define HAVE_fpcmpule16si_vis ((TARGET_VIS4) && (Pmode == SImode))
#define HAVE_fpcmpune16si_vis ((TARGET_VIS4) && (Pmode == SImode))
#define HAVE_fpcmpugt16si_vis ((TARGET_VIS4) && (Pmode == SImode))
#define HAVE_fpcmpueq16si_vis ((TARGET_VIS4) && (Pmode == SImode))
#define HAVE_fpcmpule32si_vis ((TARGET_VIS4) && (Pmode == SImode))
#define HAVE_fpcmpune32si_vis ((TARGET_VIS4) && (Pmode == SImode))
#define HAVE_fpcmpugt32si_vis ((TARGET_VIS4) && (Pmode == SImode))
#define HAVE_fpcmpueq32si_vis ((TARGET_VIS4) && (Pmode == SImode))
#define HAVE_fpcmpule16di_vis ((TARGET_VIS4) && (Pmode == DImode))
#define HAVE_fpcmpune16di_vis ((TARGET_VIS4) && (Pmode == DImode))
#define HAVE_fpcmpugt16di_vis ((TARGET_VIS4) && (Pmode == DImode))
#define HAVE_fpcmpueq16di_vis ((TARGET_VIS4) && (Pmode == DImode))
#define HAVE_fpcmpule32di_vis ((TARGET_VIS4) && (Pmode == DImode))
#define HAVE_fpcmpune32di_vis ((TARGET_VIS4) && (Pmode == DImode))
#define HAVE_fpcmpugt32di_vis ((TARGET_VIS4) && (Pmode == DImode))
#define HAVE_fpcmpueq32di_vis ((TARGET_VIS4) && (Pmode == DImode))
...
#define HAVE_atomic_loaddi_1 (!TARGET_ARCH64)
#define HAVE_atomic_storedi_1 (!TARGET_ARCH64)
#define HAVE_swapsi ((TARGET_V8 || TARGET_V9) && !sparc_fix_ut699)
#define HAVE_ldstub (!sparc_fix_ut699)
#define HAVE_cstoresi4 1
#define HAVE_cstoredi4 (TARGET_ARCH64)
#define HAVE_cstoresf4 (TARGET_FPU)
#define HAVE_cstoredf4 (TARGET_FPU)
#define HAVE_cstoretf4 (TARGET_FPU)
#define HAVE_seqsisi_special (Pmode == SImode)
#define HAVE_seqsidi_special (Pmode == DImode)
#define HAVE_seqdi_special (TARGET_ARCH64)
#define HAVE_snesisi_special (Pmode == SImode)
#define HAVE_snesidi_special (Pmode == DImode)
#define HAVE_snedi_special (TARGET_ARCH64 && ! TARGET_VIS3)
#define HAVE_snedi_special_vis3 (TARGET_ARCH64 && TARGET_VIS3)
#define HAVE_cbranchcc4 1
#define HAVE_cbranchsi4 1
#define HAVE_cbranchdi4 (TARGET_ARCH64)
...
#define HAVE_reload_outdi ((TARGET_CM_MEDANY \
    || TARGET_CM_EMBMEDANY) \
   && ! flag_pic)
#define HAVE_movti (TARGET_ARCH64)
#define HAVE_movsf 1
#define HAVE_movdf 1
#define HAVE_movtf 1
...
#define HAVE_zero_extendqidi2 (TARGET_ARCH64)
#define HAVE_zero_extendhidi2 (TARGET_ARCH64)
#define HAVE_zero_extendsidi2 1
#define HAVE_extendhisi2 1
#define HAVE_extendqihi2 1
#define HAVE_extendqisi2 1
#define HAVE_extendqidi2 (TARGET_ARCH64)
#define HAVE_extendhidi2 (TARGET_ARCH64)
#define HAVE_extendsidi2 (TARGET_ARCH64)
...
#define HAVE_ctrapdi4 (TARGET_ARCH64)
...
extern rtx        gen_addxc                         (rtx, rtx, rtx);
...
extern rtx        gen_edge8di_vis                   (rtx, rtx, rtx);
extern rtx        gen_edge8lsi_vis                  (rtx, rtx, rtx);
extern rtx        gen_edge8ldi_vis                  (rtx, rtx, rtx);
extern rtx        gen_edge16si_vis                  (rtx, rtx, rtx);
extern rtx        gen_edge16di_vis                  (rtx, rtx, rtx);
extern rtx        gen_edge16lsi_vis                 (rtx, rtx, rtx);
extern rtx        gen_edge16ldi_vis                 (rtx, rtx, rtx);
extern rtx        gen_edge32si_vis                  (rtx, rtx, rtx);
extern rtx        gen_edge32di_vis                  (rtx, rtx, rtx);
extern rtx        gen_edge32lsi_vis                 (rtx, rtx, rtx);
extern rtx        gen_edge32ldi_vis                 (rtx, rtx, rtx);
...
extern rtx        gen_fcmple16di_vis                (rtx, rtx, rtx);
extern rtx        gen_fcmpne16di_vis                (rtx, rtx, rtx);
extern rtx        gen_fcmpgt16di_vis                (rtx, rtx, rtx);
extern rtx        gen_fcmpeq16di_vis                (rtx, rtx, rtx);
...
extern rtx        gen_fcmple32di_vis                (rtx, rtx, rtx);
extern rtx        gen_fcmpne32di_vis                (rtx, rtx, rtx);
extern rtx        gen_fcmpgt32di_vis                (rtx, rtx, rtx);
extern rtx        gen_fcmpeq32di_vis                (rtx, rtx, rtx);
...
extern rtx        gen_fpcmple8di_vis                (rtx, rtx, rtx);
extern rtx        gen_fpcmpne8di_vis                (rtx, rtx, rtx);
extern rtx        gen_fpcmpgt8di_vis                (rtx, rtx, rtx);
extern rtx        gen_fpcmpeq8di_vis                (rtx, rtx, rtx);
extern rtx        gen_array8si_vis                  (rtx, rtx, rtx);
extern rtx        gen_array8di_vis                  (rtx, rtx, rtx);
extern rtx        gen_array16si_vis                 (rtx, rtx, rtx);
extern rtx        gen_array16di_vis                 (rtx, rtx, rtx);
extern rtx        gen_array32si_vis                 (rtx, rtx, rtx);
extern rtx        gen_array32di_vis                 (rtx, rtx, rtx);
...
extern rtx        gen_edge8ndi_vis                  (rtx, rtx, rtx);
extern rtx        gen_edge8lnsi_vis                 (rtx, rtx, rtx);
extern rtx        gen_edge8lndi_vis                 (rtx, rtx, rtx);
extern rtx        gen_edge16nsi_vis                 (rtx, rtx, rtx);
extern rtx        gen_edge16ndi_vis                 (rtx, rtx, rtx);
extern rtx        gen_edge16lnsi_vis                (rtx, rtx, rtx);
extern rtx        gen_edge16lndi_vis                (rtx, rtx, rtx);
extern rtx        gen_edge32nsi_vis                 (rtx, rtx, rtx);
extern rtx        gen_edge32ndi_vis                 (rtx, rtx, rtx);
extern rtx        gen_edge32lnsi_vis                (rtx, rtx, rtx);
extern rtx        gen_edge32lndi_vis                (rtx, rtx, rtx);
extern rtx        gen_cmask8si_vis                  (rtx);
extern rtx        gen_cmask8di_vis                  (rtx);
extern rtx        gen_cmask16si_vis                 (rtx);
extern rtx        gen_cmask16di_vis                 (rtx);
extern rtx        gen_cmask32si_vis                 (rtx);
extern rtx        gen_cmask32di_vis                 (rtx);
...
extern rtx        gen_pdistndi_vis                  (rtx, rtx, rtx);
...
extern rtx        gen_fucmple8di_vis                (rtx, rtx, rtx);
extern rtx        gen_fucmpne8di_vis                (rtx, rtx, rtx);
extern rtx        gen_fucmpgt8di_vis                (rtx, rtx, rtx);
extern rtx        gen_fucmpeq8di_vis                (rtx, rtx, rtx);
...
extern rtx        gen_fpcmpule16di_vis              (rtx, rtx, rtx);
extern rtx        gen_fpcmpune16di_vis              (rtx, rtx, rtx);
extern rtx        gen_fpcmpugt16di_vis              (rtx, rtx, rtx);
extern rtx        gen_fpcmpueq16di_vis              (rtx, rtx, rtx);
extern rtx        gen_fpcmpule32di_vis              (rtx, rtx, rtx);
extern rtx        gen_fpcmpune32di_vis              (rtx, rtx, rtx);
extern rtx        gen_fpcmpugt32di_vis              (rtx, rtx, rtx);
extern rtx        gen_fpcmpueq32di_vis              (rtx, rtx, rtx);
...
extern rtx        gen_seqsisi_special               (rtx, rtx, rtx);
extern rtx        gen_seqsidi_special               (rtx, rtx, rtx);
extern rtx        gen_seqdi_special                 (rtx, rtx, rtx);
extern rtx        gen_snesisi_special               (rtx, rtx, rtx);
extern rtx        gen_snesidi_special               (rtx, rtx, rtx);
extern rtx        gen_snedi_special                 (rtx, rtx, rtx);
extern rtx        gen_snedi_special_vis3            (rtx, rtx, rtx);
