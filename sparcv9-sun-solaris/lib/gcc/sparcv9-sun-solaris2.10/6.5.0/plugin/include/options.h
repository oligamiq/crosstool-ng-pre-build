...
#define MASK_CBCOND (1 << 2)
#define MASK_FASTER_STRUCTS (1 << 3)
#define MASK_FLAT (1 << 4)
#define MASK_FMAF (1 << 5)
#define MASK_FPU (1 << 6)
#define MASK_HARD_QUAD (1 << 7)
#define MASK_POPC (1 << 8)
#define MASK_PTR64 (1 << 9)
#define MASK_STACK_BIAS (1 << 10)
#define MASK_UNALIGNED_DOUBLES (1 << 11)
#define MASK_SV_MODE (1 << 12)
#define MASK_V8PLUS (1 << 13)
#define MASK_VIS (1 << 14)
#define MASK_VIS2 (1 << 15)
#define MASK_VIS3 (1 << 16)
#define MASK_VIS4 (1 << 17)
#define MASK_DEPRECATED_V8_INSNS (1 << 18)
#define MASK_LEON (1 << 19)
#define MASK_LEON3 (1 << 20)
#define MASK_LONG_DOUBLE_128 (1 << 21)
#define MASK_SPARCLET (1 << 22)
#define MASK_SPARCLITE (1 << 23)
#define MASK_V8 (1 << 24)
#define MASK_V9 (1 << 25)
...
enum opt_code
{
  ...
  OPT_m32 = 1184,                            /* -m32 */
  OPT_m64 = 1185,                            /* -m64 */
  OPT_mapp_regs = 1186,                      /* -mapp-regs */
  OPT_mcbcond = 1187,                        /* -mcbcond */
  OPT_mclear_hwcap = 1188,                   /* -mclear-hwcap */
  OPT_mcmodel_ = 1189,                       /* -mcmodel= */
  OPT_mcpu_ = 1190,                          /* -mcpu= */
  OPT_mdebug_ = 1191,                        /* -mdebug= */
  OPT_mfaster_structs = 1192,                /* -mfaster-structs */
  OPT_mfix_at697f = 1193,                    /* -mfix-at697f */
  OPT_mfix_ut699 = 1194,                     /* -mfix-ut699 */
  OPT_mflat = 1195,                          /* -mflat */
  OPT_mfmaf = 1196,                          /* -mfmaf */
  OPT_mfpu = 1197,                           /* -mfpu */
  OPT_mhard_float = 1198,                    /* -mhard-float */
  OPT_mhard_quad_float = 1199,               /* -mhard-quad-float */
  OPT_mimpure_text = 1200,                   /* -mimpure-text */
  OPT_mmemory_model_ = 1201,                 /* -mmemory-model= */
  OPT_mpopc = 1202,                          /* -mpopc */
  OPT_mptr32 = 1203,                         /* -mptr32 */
  OPT_mptr64 = 1204,                         /* -mptr64 */
  OPT_mrelax = 1205,                         /* -mrelax */
  OPT_msoft_float = 1206,                    /* -msoft-float */
  OPT_msoft_quad_float = 1207,               /* -msoft-quad-float */
  OPT_mstack_bias = 1208,                    /* -mstack-bias */
  OPT_mstd_struct_return = 1209,             /* -mstd-struct-return */
  OPT_mtune_ = 1210,                         /* -mtune= */
  OPT_munaligned_doubles = 1211,             /* -munaligned-doubles */
  OPT_muser_mode = 1212,                     /* -muser-mode */
  OPT_mv8plus = 1213,                        /* -mv8plus */
  OPT_mvis = 1214,                           /* -mvis */
  OPT_mvis2 = 1215,                          /* -mvis2 */
  OPT_mvis3 = 1216,                          /* -mvis3 */
  OPT_mvis4 = 1217,                          /* -mvis4 */
  OPT_n = 1218,                              /* -n */
  ...
  OPT_static_libgcj = 1264,                  /* -static-libgcj */
  ...
  /* OPT_std_c1x = 1282, */                  /* -std=c1x */
  /* OPT_std_c89 = 1283, */                  /* -std=c89 */
  OPT_std_c90 = 1284,                        /* -std=c90 */
  OPT_std_c99 = 1285,                        /* -std=c99 */
  /* OPT_std_c9x = 1286, */                  /* -std=c9x */
  OPT_std_f2003 = 1287,                      /* -std=f2003 */
  OPT_std_f2008 = 1288,                      /* -std=f2008 */
  OPT_std_f2008ts = 1289,                    /* -std=f2008ts */
  OPT_std_f95 = 1290,                        /* -std=f95 */
  OPT_std_gnu = 1291,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1292, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1293, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1294,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1295,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1296, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1297, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1298,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1299,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1300,                      /* -std=gnu11 */
  ...
  OPT_std_legacy = 1311,                     /* -std=legacy */
  OPT_symbolic = 1312,                       /* -symbolic */
  OPT_t = 1313,                              /* -t */
  OPT_time = 1314,                           /* -time */
  OPT_time_ = 1315,                          /* -time= */
  OPT_traditional = 1316,                    /* -traditional */
  OPT_traditional_cpp = 1317,                /* -traditional-cpp */
  OPT_trigraphs = 1318,                      /* -trigraphs */
  OPT_u = 1319,                              /* -u */
  OPT_undef = 1320,                          /* -undef */
  OPT_v = 1321,                              /* -v */
  OPT_version = 1322,                        /* -version */
  OPT_w = 1323,                              /* -w */
  OPT_wrapper = 1324,                        /* -wrapper */
  OPT_x = 1325,                              /* -x */
  OPT_z = 1326,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
