/*  DO NOT EDIT THIS FILE.
	...
	"/x-tools/sparcv9-sun-solaris2.10/sysroot/usr/include/netinet/ip_compat.h"
...
# if (defined(_KERNEL) || defined(_NO_BITFIELDS) || ( defined(__STRICT_ANSI__)))
...
/*                                  S U N O S 4                            */
/* ----------------------------------------------------------------------- */
#if defined(__sun__) && !defined(OS_RECOGNISED) /* SunOS4 */
# ifdef _KERNEL
