...
enum opt_code
{
  ...
  OPT_Z = 458,                               /* -Z */
  OPT_ansi = 459,                            /* -ansi */
  OPT_assert = 460,                          /* -assert */
  OPT_assert_ = 461,                         /* -assert= */
  ...
  OPT_cpp_ = 469,                            /* -cpp= */
  OPT_d = 470,                               /* -d */
  OPT_defsym = 471,                          /* -defsym */
  OPT_defsym_ = 472,                         /* -defsym= */
  OPT_dumpbase = 473,                        /* -dumpbase */
  OPT_dumpdir = 474,                         /* -dumpdir */
  OPT_dumpfullversion = 475,                 /* -dumpfullversion */
  ...
  OPT_fPIE = 482,                            /* -fPIE */
  OPT_fRTS_ = 483,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 484,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 485,                   /* -fabi-version= */
  OPT_faccess_control = 486,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 487,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 488,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 489,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 490,                  /* -falign-commons */
  OPT_falign_functions = 491,                /* -falign-functions */
  OPT_falign_functions_ = 492,               /* -falign-functions= */
  OPT_falign_jumps = 493,                    /* -falign-jumps */
  OPT_falign_jumps_ = 494,                   /* -falign-jumps= */
  OPT_falign_labels = 495,                   /* -falign-labels */
  OPT_falign_labels_ = 496,                  /* -falign-labels= */
  OPT_falign_loops = 497,                    /* -falign-loops */
  OPT_falign_loops_ = 498,                   /* -falign-loops= */
  /* OPT_faligned_new = 499, */              /* -faligned-new */
  OPT_faligned_new_ = 500,                   /* -faligned-new= */
  ...
  /* OPT_fargument_alias = 506, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 507, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 508, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 509, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 510,            /* -fasan-shadow-offset= */
  OPT_fasm = 511,                            /* -fasm */
  OPT_fassociative_math = 512,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 513,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 514,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 515,                   /* -fauto-profile */
  OPT_fauto_profile_ = 516,                  /* -fauto-profile= */
  OPT_fautomatic = 517,                      /* -fautomatic */
  OPT_fbackslash = 518,                      /* -fbackslash */
  OPT_fbacktrace = 519,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 520,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 521,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 522,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 523,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 524,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 525,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 526,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 527,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 528,                        /* -fbuiltin */
  OPT_fbuiltin_ = 529,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 530,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 531,                   /* -fc-prototypes */
  ...
  /* OPT_fcf_protection = 536, */            /* -fcf-protection */
  OPT_fcf_protection_ = 537,                 /* -fcf-protection= */
  ...
  OPT_fcheck_pointer_bounds = 541,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 542,                         /* -fcheck= */
  OPT_fchecking = 543,                       /* -fchecking */
  OPT_fchecking_ = 544,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 545,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 546,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 547,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 548,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 549,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 550,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 551,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 552,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 553, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 554,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 555,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 556,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 557, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 558,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 559,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 560,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 561,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 562,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 563,                       /* -fcilkplus */
  OPT_fcoarray_ = 564,                       /* -fcoarray= */
  OPT_fcode_hoisting = 565,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 566,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 567,                         /* -fcommon */
  OPT_fcompare_debug = 568,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 569,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 570,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 571,                   /* -fcompare-elim */
  OPT_fconcepts = 572,                       /* -fconcepts */
  OPT_fcond_mismatch = 573,                  /* -fcond-mismatch */
  OPT_fconserve_space = 574,                 /* -fconserve-space */
  OPT_fconserve_stack = 575,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 576,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 577,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 578,          /* -fconstexpr-loop-limit= */
  OPT_fconvert_ = 579,                       /* -fconvert= */
  OPT_fcprop_registers = 580,                /* -fcprop-registers */
  OPT_fcray_pointer = 581,                   /* -fcray-pointer */
  OPT_fcrossjumping = 582,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 583,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 584, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 585,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 586,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 587,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 588,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 589,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 590,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 591,                       /* -fdbg-cnt= */
  OPT_fdce = 592,                            /* -fdce */
  OPT_fdebug_cpp = 593,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 594,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 595,            /* -fdebug-types-section */
  OPT_fdec = 596,                            /* -fdec */
  OPT_fdec_intrinsic_ints = 597,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 598,                       /* -fdec-math */
  OPT_fdec_static = 599,                     /* -fdec-static */
  OPT_fdec_structure = 600,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 601,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 602,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 603,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 604, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 605,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 606,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 607,                /* -fdefault-real-16 */
  ...
  OPT_fdiagnostics_generate_patch = 618,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_parseable_fixits = 619,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 620,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 621,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 622,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 623, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 624,                /* -fdirectives-only */
  OPT_fdisable_ = 625,                       /* -fdisable- */
  OPT_fdollar_ok = 626,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 627,         /* -fdollars-in-identifiers */
  OPT_fdse = 628,                            /* -fdse */
  OPT_fdump_ = 629,                          /* -fdump- */
  OPT_fdump_ada_spec = 630,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 631,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 632, */                /* -fdump-core */
  OPT_fdump_final_insns = 633,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 634,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 635,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 636,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 637,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 638,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 639,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 640, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 641,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 642,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 643,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 644,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 645,                 /* -fearly-inlining */
  OPT_felide_constructors = 646,             /* -felide-constructors */
  OPT_felide_type = 647,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 648, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 649, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 650,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 651,        /* -femit-class-debug-always */
  ...
  OPT_fextended_identifiers = 663,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 664,                /* -fextern-tls-init */
  OPT_fexternal_blas = 665,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 666, */       /* -fexternal-templates */
  OPT_ff2c = 667,                            /* -ff2c */
  OPT_ffast_math = 668,                      /* -ffast-math */
  OPT_ffat_lto_objects = 669,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 670,               /* -ffile-prefix-map= */
  OPT_ffinite_math_only = 671,               /* -ffinite-math-only */
  OPT_ffixed_ = 672,                         /* -ffixed- */
  OPT_ffixed_form = 673,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 674,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 675,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 676,                    /* -ffloat-store */
  OPT_ffor_scope = 677,                      /* -ffor-scope */
  /* OPT_fforce_addr = 678, */               /* -fforce-addr */
  OPT_fforward_propagate = 679,              /* -fforward-propagate */
  OPT_ffp_contract_ = 680,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 681,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 682,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 683,                      /* -ffpe-trap= */
  OPT_ffree_form = 684,                      /* -ffree-form */
  OPT_ffree_line_length_ = 685,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 686,          /* -ffree-line-length-none */
  OPT_ffreestanding = 687,                   /* -ffreestanding */
  OPT_ffriend_injection = 688,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 689,      /* -ffrontend-loop-interchange */
  ...
  OPT_fgimple = 698,                         /* -fgimple */
  OPT_fgnat_encodings_ = 699,                /* -fgnat-encodings= */
  ...
  OPT_fgo_c_header_ = 705,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 706,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 707,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 708,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 709,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 710,          /* -fgo-debug-escape-hash= */
  OPT_fgo_dump_ = 711,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 712,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 713,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 714,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 715,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 716,                       /* -fgraphite */
  OPT_fgraphite_identity = 717,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 718,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 719, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 720, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 721, */                     /* -fhelp */
  /* OPT_fhelp_ = 722, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 723,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 724, */                /* -fhonor-std */
  ...
  OPT_m128bit_long_double = 1196,            /* -m128bit-long-double */
  OPT_m16 = 1197,                            /* -m16 */
  OPT_m32 = 1198,                            /* -m32 */
  OPT_m3dnow = 1199,                         /* -m3dnow */
  OPT_m3dnowa = 1200,                        /* -m3dnowa */
  OPT_m64 = 1201,                            /* -m64 */
  OPT_m80387 = 1202,                         /* -m80387 */
  OPT_m8bit_idiv = 1203,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1204,             /* -m96bit-long-double */
  OPT_mabi_ = 1205,                          /* -mabi= */
  OPT_mabm = 1206,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1207,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1208,                 /* -maddress-mode= */
  OPT_madx = 1209,                           /* -madx */
  OPT_maes = 1210,                           /* -maes */
  OPT_malign_data_ = 1211,                   /* -malign-data= */
  OPT_malign_double = 1212,                  /* -malign-double */
  OPT_malign_functions_ = 1213,              /* -malign-functions= */
  OPT_malign_jumps_ = 1214,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1215,                  /* -malign-loops= */
  OPT_malign_stringops = 1216,               /* -malign-stringops */
  OPT_march_ = 1217,                         /* -march= */
  OPT_masm_ = 1218,                          /* -masm= */
  OPT_mavx = 1219,                           /* -mavx */
  OPT_mavx2 = 1220,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1221,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1222,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1223,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1224,                  /* -mavx5124vnniw */
  OPT_mavx512bitalg = 1225,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1226,                      /* -mavx512bw */
  OPT_mavx512cd = 1227,                      /* -mavx512cd */
  OPT_mavx512dq = 1228,                      /* -mavx512dq */
  OPT_mavx512er = 1229,                      /* -mavx512er */
  OPT_mavx512f = 1230,                       /* -mavx512f */
  OPT_mavx512ifma = 1231,                    /* -mavx512ifma */
  OPT_mavx512pf = 1232,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1233,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1234,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1235,                      /* -mavx512vl */
  OPT_mavx512vnni = 1236,                    /* -mavx512vnni */
  OPT_mavx512vpopcntdq = 1237,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1238,                           /* -mbmi */
  OPT_mbmi2 = 1239,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1240,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1241,          /* -mcall-ms2sysv-xlogues */
  ...
  OPT_mnop_mcount = 1300,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1301,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1302,                          /* -mpc32 */
  OPT_mpc64 = 1303,                          /* -mpc64 */
  OPT_mpc80 = 1304,                          /* -mpc80 */
  OPT_mpclmul = 1305,                        /* -mpclmul */
  OPT_mpcommit = 1306,                       /* -mpcommit */
  OPT_mpconfig = 1307,                       /* -mpconfig */
  OPT_mpku = 1308,                           /* -mpku */
  OPT_mpopcnt = 1309,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1310, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1311,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1312,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1313,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1314,                        /* -mprfchw */
  OPT_mpush_args = 1315,                     /* -mpush-args */
  OPT_mrdpid = 1316,                         /* -mrdpid */
  OPT_mrdrnd = 1317,                         /* -mrdrnd */
  OPT_mrdseed = 1318,                        /* -mrdseed */
  OPT_mrecip = 1319,                         /* -mrecip */
  OPT_mrecip_ = 1320,                        /* -mrecip= */
  OPT_mrecord_mcount = 1321,                 /* -mrecord-mcount */
  OPT_mred_zone = 1322,                      /* -mred-zone */
  OPT_mregparm_ = 1323,                      /* -mregparm= */
  OPT_mrtd = 1324,                           /* -mrtd */
  OPT_mrtm = 1325,                           /* -mrtm */
  OPT_msahf = 1326,                          /* -msahf */
  OPT_msgx = 1327,                           /* -msgx */
  OPT_msha = 1328,                           /* -msha */
  OPT_mshstk = 1329,                         /* -mshstk */
  OPT_mskip_rax_setup = 1330,                /* -mskip-rax-setup */
  OPT_msoft_float = 1331,                    /* -msoft-float */
  OPT_msse = 1332,                           /* -msse */
  OPT_msse2 = 1333,                          /* -msse2 */
  OPT_msse2avx = 1334,                       /* -msse2avx */
  OPT_msse3 = 1335,                          /* -msse3 */
  OPT_msse4 = 1336,                          /* -msse4 */
  OPT_msse4_1 = 1337,                        /* -msse4.1 */
  OPT_msse4_2 = 1338,                        /* -msse4.2 */
  OPT_msse4a = 1339,                         /* -msse4a */
  /* OPT_msse5 = 1340, */                    /* -msse5 */
  OPT_msseregparm = 1341,                    /* -msseregparm */
  OPT_mssse3 = 1342,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1343,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1344, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1345,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1346, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1347,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1348,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1349,            /* -mstringop-strategy= */
  OPT_mstv = 1350,                           /* -mstv */
  OPT_mtbm = 1351,                           /* -mtbm */
  OPT_mtls_dialect_ = 1352,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1353,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1354,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1355,                         /* -mtune= */
  OPT_mvaes = 1356,                          /* -mvaes */
  OPT_mveclibabi_ = 1357,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1358,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1359,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1360,                    /* -mvzeroupper */
  OPT_mwbnoinvd = 1361,                      /* -mwbnoinvd */
  OPT_mx32 = 1362,                           /* -mx32 */
  OPT_mxop = 1363,                           /* -mxop */
  OPT_mxsave = 1364,                         /* -mxsave */
  OPT_mxsavec = 1365,                        /* -mxsavec */
  OPT_mxsaveopt = 1366,                      /* -mxsaveopt */
  OPT_mxsaves = 1367,                        /* -mxsaves */
  OPT_n = 1368,                              /* -n */
  OPT_no_canonical_prefixes = 1369,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1370,              /* -no-integrated-cpp */
  OPT_no_pie = 1371,                         /* -no-pie */
  OPT_nocpp = 1372,                          /* -nocpp */
  OPT_nodefaultlibs = 1373,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1374,                   /* -nostartfiles */
  OPT_nostdinc = 1375,                       /* -nostdinc */
  OPT_nostdinc__ = 1376,                     /* -nostdinc++ */
  OPT_nostdlib = 1377,                       /* -nostdlib */
  OPT_o = 1378,                              /* -o */
  OPT_p = 1379,                              /* -p */
  OPT_pass_exit_codes = 1380,                /* -pass-exit-codes */
  /* OPT_pedantic = 1381, */                 /* -pedantic */
  OPT_pedantic_errors = 1382,                /* -pedantic-errors */
  OPT_pg = 1383,                             /* -pg */
  OPT_pie = 1384,                            /* -pie */
  OPT_pipe = 1385,                           /* -pipe */
  OPT_posix = 1386,                          /* -posix */
  OPT_print_file_name_ = 1387,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1388,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1389,          /* -print-multi-directory */
  OPT_print_multi_lib = 1390,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1391,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1392,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1393,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1394,               /* -print-prog-name= */
  OPT_print_search_dirs = 1395,              /* -print-search-dirs */
  OPT_print_sysroot = 1396,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1397,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1398,                        /* -profile */
  OPT_pthread = 1399,                        /* -pthread */
  OPT_quiet = 1400,                          /* -quiet */
  OPT_r = 1401,                              /* -r */
  OPT_rdynamic = 1402,                       /* -rdynamic */
  OPT_remap = 1403,                          /* -remap */
  OPT_rpath = 1404,                          /* -rpath */
  OPT_rpath_link = 1405,                     /* -rpath-link */
  OPT_rpath_link_ = 1406,                    /* -rpath-link= */
  OPT_rpath_ = 1407,                         /* -rpath= */
  OPT_s = 1408,                              /* -s */
  OPT_save_temps = 1409,                     /* -save-temps */
  OPT_save_temps_ = 1410,                    /* -save-temps= */
  OPT_shared = 1411,                         /* -shared */
  OPT_shared_libgcc = 1412,                  /* -shared-libgcc */
  OPT_soname = 1413,                         /* -soname */
  OPT_soname_ = 1414,                        /* -soname= */
