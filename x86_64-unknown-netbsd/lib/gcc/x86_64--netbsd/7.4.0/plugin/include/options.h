...
#define CL_LTO        (1U << 3)
#define CL_ObjC       (1U << 4)
#define CL_ObjCXX     (1U << 5)
#define CL_LANG_ALL   ((1U << 6) - 1)
...
enum opt_code
{
  ...
  /* OPT_Waligned_new = 152, */              /* -Waligned-new */
  OPT_Waligned_new_ = 153,                   /* -Waligned-new= */
  OPT_Wall = 154,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 155,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 156,                     /* -Walloc-zero */
  OPT_Walloca = 157,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 158,            /* -Walloca-larger-than= */
  OPT_Warray_bounds = 159,                   /* -Warray-bounds */
  OPT_Warray_bounds_ = 160,                  /* -Warray-bounds= */
  OPT_Wassign_intercept = 161,               /* -Wassign-intercept */
  OPT_Wattributes = 162,                     /* -Wattributes */
  OPT_Wbad_function_cast = 163,              /* -Wbad-function-cast */
  OPT_Wbool_compare = 164,                   /* -Wbool-compare */
  OPT_Wbool_operation = 165,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 166,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 167,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 168,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 169, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 170,                   /* -Wc++11-compat */
  OPT_Wc__14_compat = 171,                   /* -Wc++14-compat */
  /* OPT_Wc__17_compat = 172, */             /* -Wc++17-compat */
  OPT_Wc__1z_compat = 173,                   /* -Wc++1z-compat */
  OPT_Wc90_c99_compat = 174,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 175,                 /* -Wc99-c11-compat */
  ...
  OPT_Wconditionally_supported = 183,        /* -Wconditionally-supported */
  OPT_Wconversion = 184,                     /* -Wconversion */
  ...
  OPT_Wdangling_else = 189,                  /* -Wdangling-else */
  OPT_Wdate_time = 190,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 191,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 192,              /* -Wdelete-incomplete */
  ...
  OPT_Wdesignated_init = 196,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 197,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 198,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 199,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 200,                    /* -Wdiv-by-zero */
  OPT_Wdouble_promotion = 201,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 202,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 203,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 204,                /* -Wduplicated-cond */
  ...
  OPT_Wexpansion_to_defined = 212,           /* -Wexpansion-to-defined */
  OPT_Wextra = 213,                          /* -Wextra */
  OPT_Wfatal_errors = 214,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 215,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 216,                    /* -Wfloat-equal */
  /* OPT_Wformat = 217, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 218,            /* -Wformat-contains-nul */
  OPT_Wformat_extra_args = 219,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 220,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 221, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 222,               /* -Wformat-overflow= */
  OPT_Wformat_security = 223,                /* -Wformat-security */
  OPT_Wformat_signedness = 224,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 225, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 226,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 227,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 228,             /* -Wformat-zero-length */
  OPT_Wformat_ = 229,                        /* -Wformat= */
  OPT_Wframe_address = 230,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 231,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 232,            /* -Wfree-nonheap-object */
  OPT_Whsa = 233,                            /* -Whsa */
  OPT_Wignored_attributes = 234,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 235,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 236,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 237, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 238,          /* -Wimplicit-fallthrough= */
  ...
  OPT_Wincompatible_pointer_types = 242,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 243,        /* -Winherited-variadic-ctor */
  OPT_Winit_self = 244,                      /* -Winit-self */
  OPT_Winline = 245,                         /* -Winline */
  OPT_Wint_conversion = 246,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 247,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 248,            /* -Wint-to-pointer-cast */
  ...
  OPT_Wliteral_suffix = 256,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 257,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 258,                     /* -Wlogical-op */
  OPT_Wlong_long = 259,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 260,              /* -Wlto-type-mismatch */
  OPT_Wmain = 261,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 262,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 263,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 264,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 265,         /* -Wmisleading-indentation */
  ...
  OPT_Wmultiple_inheritance = 276,           /* -Wmultiple-inheritance */
  OPT_Wnamespaces = 277,                     /* -Wnamespaces */
  OPT_Wnarrowing = 278,                      /* -Wnarrowing */
  OPT_Wnested_externs = 279,                 /* -Wnested-externs */
  OPT_Wnoexcept = 280,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 281,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 282,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 283,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 284,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 285,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 286, */               /* -Wnormalized */
  OPT_Wnormalized_ = 287,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 288,               /* -Wnull-dereference */
  OPT_Wodr = 289,                            /* -Wodr */
  ...
  OPT_Wopenmp_simd = 293,                    /* -Wopenmp-simd */
  OPT_Woverflow = 294,                       /* -Woverflow */
  OPT_Woverlength_strings = 295,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 296,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 297,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 298,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 299,                             /* -Wp, */
  OPT_Wpacked = 300,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 301,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 302,                         /* -Wpadded */
  OPT_Wparentheses = 303,                    /* -Wparentheses */
  OPT_Wpedantic = 304,                       /* -Wpedantic */
  /* OPT_Wplacement_new = 305, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 306,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 307,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 308,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 309,                /* -Wpointer-compare */
  ...
  OPT_Wregister = 317,                       /* -Wregister */
  OPT_Wreorder = 318,                        /* -Wreorder */
  OPT_Wrestrict = 319,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 320,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 321,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 322,           /* -Wscalar-storage-order */
  OPT_Wselector = 323,                       /* -Wselector */
  OPT_Wsequence_point = 324,                 /* -Wsequence-point */
  OPT_Wshadow = 325,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 326, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 327,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 328, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 329,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 330, */            /* -Wshadow=global */
  OPT_Wshadow_local = 331,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 332,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 333,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 334,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 335, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 336,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 337,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 338,                /* -Wsign-conversion */
  OPT_Wsign_promo = 339,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 340,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 341,          /* -Wsizeof-array-argument */
  ...
  /* OPT_Wstringop_overflow = 352, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 353,             /* -Wstringop-overflow= */
  OPT_Wsubobject_linkage = 354,              /* -Wsubobject-linkage */
  ...
  OPT_Wsuggest_final_methods = 359,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 360,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 361,               /* -Wsuggest-override */
  OPT_Wswitch = 362,                         /* -Wswitch */
  OPT_Wswitch_bool = 363,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 364,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 365,                    /* -Wswitch-enum */
  OPT_Wswitch_unreachable = 366,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 367,                      /* -Wsync-nand */
  OPT_Wsynth = 368,                          /* -Wsynth */
  OPT_Wsystem_headers = 369,                 /* -Wsystem-headers */
  OPT_Wtautological_compare = 370,           /* -Wtautological-compare */
  OPT_Wtemplates = 371,                      /* -Wtemplates */
  OPT_Wterminate = 372,                      /* -Wterminate */
  OPT_Wtraditional = 373,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 374,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 375,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 376,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 377,                    /* -Wtype-limits */
  ...
  /* OPT_Wunused_const_variable = 388, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 389,         /* -Wunused-const-variable= */
  ...
  OPT_Wvirtual_inheritance = 402,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 403,            /* -Wvirtual-move-assign */
  OPT_Wvla = 404,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 405,               /* -Wvla-larger-than= */
  ...
  OPT_cxx_isystem = 421,                     /* -cxx-isystem */
  OPT_d = 422,                               /* -d */
  OPT_dumpbase = 423,                        /* -dumpbase */
  OPT_dumpdir = 424,                         /* -dumpdir */
  OPT_dumpfullversion = 425,                 /* -dumpfullversion */
  ...
  OPT_fPIC = 431,                            /* -fPIC */
  OPT_fPIE = 432,                            /* -fPIE */
  OPT_fabi_compat_version_ = 433,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 434,                   /* -fabi-version= */
  OPT_faccess_control = 435,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 436,               /* -fada-spec-parent= */
  OPT_faggressive_loop_optimizations = 437,  /* -faggressive-loop-optimizations */
  OPT_falign_functions = 438,                /* -falign-functions */
  OPT_falign_functions_ = 439,               /* -falign-functions= */
  OPT_falign_jumps = 440,                    /* -falign-jumps */
  OPT_falign_jumps_ = 441,                   /* -falign-jumps= */
  OPT_falign_labels = 442,                   /* -falign-labels */
  OPT_falign_labels_ = 443,                  /* -falign-labels= */
  OPT_falign_loops = 444,                    /* -falign-loops */
  OPT_falign_loops_ = 445,                   /* -falign-loops= */
  /* OPT_faligned_new = 446, */              /* -faligned-new */
  OPT_faligned_new_ = 447,                   /* -faligned-new= */
  /* OPT_fall_virtual = 448, */              /* -fall-virtual */
  OPT_fallow_parameterless_variadic_functions = 449,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 450, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 451, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 452, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 453, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 454, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 455,            /* -fasan-shadow-offset= */
  OPT_fasm = 456,                            /* -fasm */
  OPT_fassociative_math = 457,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 458,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 459,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 460,                   /* -fauto-profile */
  OPT_fauto_profile_ = 461,                  /* -fauto-profile= */
  OPT_fbounds_check = 462,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 463,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 464,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 465,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 466,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 467,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 468,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 469,                        /* -fbuiltin */
  OPT_fbuiltin_ = 470,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 471,                    /* -fcall-saved- */
  OPT_fcall_used_ = 472,                     /* -fcall-used- */
  OPT_fcaller_saves = 473,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 474,       /* -fcanonical-system-headers */
  OPT_fcheck_data_deps = 475,                /* -fcheck-data-deps */
  OPT_fcheck_new = 476,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 477,           /* -fcheck-pointer-bounds */
  OPT_fchecking = 478,                       /* -fchecking */
  OPT_fchecking_ = 479,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 480,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 481,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 482,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 483,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 484,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 485,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 486,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 487,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 488, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 489,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 490,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 491,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 492, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 493,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 494,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 495,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 496,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 497,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 498,                       /* -fcilkplus */
  OPT_fcode_hoisting = 499,                  /* -fcode-hoisting */
  ...
  OPT_fconstexpr_loop_limit_ = 512,          /* -fconstexpr-loop-limit= */
  ...
  OPT_fdebug_regex_map_ = 525,               /* -fdebug-regex-map= */
  OPT_fdebug_types_section = 526,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 527,              /* -fdeclone-ctor-dtor */
  ...
  OPT_fdevirtualize_at_ltrans = 535,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 536,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 537, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 538,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_generate_patch = 539,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_parseable_fixits = 540,   /* -fdiagnostics-parseable-fixits */
  ...
  OPT_fdump_internal_locations = 554,        /* -fdump-internal-locations */
  ...
  OPT_fenforce_eh_specs = 570,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 571, */           /* -fenum-int-equiv */
  OPT_fexceptions = 572,                     /* -fexceptions */
  OPT_fexcess_precision_ = 573,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 574,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 575,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 576,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 577,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 578,                /* -fextern-tls-init */
  /* OPT_fexternal_templates = 579, */       /* -fexternal-templates */
  OPT_ffast_math = 580,                      /* -ffast-math */
  OPT_ffat_lto_objects = 581,                /* -ffat-lto-objects */
  OPT_ffinite_math_only = 582,               /* -ffinite-math-only */
  OPT_ffixed_ = 583,                         /* -ffixed- */
  OPT_ffloat_store = 584,                    /* -ffloat-store */
  OPT_ffor_scope = 585,                      /* -ffor-scope */
  /* OPT_fforce_addr = 586, */               /* -fforce-addr */
  OPT_fforward_propagate = 587,              /* -fforward-propagate */
  OPT_ffp_contract_ = 588,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 589,         /* -ffp-int-builtin-inexact */
  OPT_ffreestanding = 590,                   /* -ffreestanding */
  OPT_ffriend_injection = 591,               /* -ffriend-injection */
  OPT_ffunction_cse = 592,                   /* -ffunction-cse */
  OPT_ffunction_sections = 593,              /* -ffunction-sections */
  OPT_fgcse = 594,                           /* -fgcse */
  OPT_fgcse_after_reload = 595,              /* -fgcse-after-reload */
  OPT_fgcse_las = 596,                       /* -fgcse-las */
  OPT_fgcse_lm = 597,                        /* -fgcse-lm */
  OPT_fgcse_sm = 598,                        /* -fgcse-sm */
  OPT_fgimple = 599,                         /* -fgimple */
  OPT_fgnat_encodings_ = 600,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 601,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 602,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 603,                         /* -fgnu-tm */
  OPT_fgnu_unique = 604,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 605,                   /* -fgnu89-inline */
  ...
  OPT_fhoist_adjacent_loads = 613,           /* -fhoist-adjacent-loads */
  ...
  OPT_fipa_bit_cp = 636,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 637,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 638, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 639,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 640,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 641,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 642,              /* -fipa-icf-variables */
  ...
  OPT_fipa_ra = 647,                         /* -fipa-ra */
  OPT_fipa_reference = 648,                  /* -fipa-reference */
  OPT_fipa_sra = 649,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 650, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 651,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 652,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 653,             /* -fira-hoist-pressure */
  ...
  OPT_fisolate_erroneous_paths_attribute = 659,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 660,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 661,               /* -fivar-visibility= */
  OPT_fivopts = 662,                         /* -fivopts */
  OPT_fjump_tables = 663,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 664,             /* -fkeep-gc-roots-live */
  ...
  OPT_fkeep_static_functions = 668,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 669, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 670,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 671,             /* -fleading-underscore */
  OPT_flifetime_dse = 672,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 673,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 674,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 675,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 676,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 677,                    /* -flocal-ivars */
  /* OPT_floop_block = 678, */               /* -floop-block */
  /* OPT_floop_flatten = 679, */             /* -floop-flatten */
  /* OPT_floop_interchange = 680, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 681,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 682, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 683,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 684, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 685, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 686,                      /* -flra-remat */
  OPT_flto = 687,                            /* -flto */
  OPT_flto_compression_level_ = 688,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 689,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 690,                 /* -flto-partition= */
  OPT_flto_report = 691,                     /* -flto-report */
  OPT_flto_report_wpa = 692,                 /* -flto-report-wpa */
  OPT_flto_ = 693,                           /* -flto= */
  OPT_fltrans = 694,                         /* -fltrans */
  OPT_fltrans_output_list_ = 695,            /* -fltrans-output-list= */
  OPT_fmath_errno = 696,                     /* -fmath-errno */
  OPT_fmax_errors_ = 697,                    /* -fmax-errors= */
  OPT_fmem_report = 698,                     /* -fmem-report */
  OPT_fmem_report_wpa = 699,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 700,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 701,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 702,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 703,                /* -fmessage-length= */
  OPT_fmodulo_sched = 704,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 705,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 706,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 707,                  /* -fms-extensions */
  /* OPT_fmudflap = 708, */                  /* -fmudflap */
  /* OPT_fmudflapir = 709, */                /* -fmudflapir */
  /* OPT_fmudflapth = 710, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 711, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 712, */                  /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 713,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 714,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 715,                   /* -fnext-runtime */
  OPT_fnil_receivers = 716,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 717,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 718,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 719, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 720,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 721,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 722,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 723,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 724,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 725,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 726,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 727,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 728,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 729,                   /* -foffload-abi= */
  OPT_foffload_ = 730,                       /* -foffload= */
  OPT_fomit_frame_pointer = 731,             /* -fomit-frame-pointer */
  OPT_fopenacc = 732,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 733,                   /* -fopenacc-dim= */
  OPT_fopenmp = 734,                         /* -fopenmp */
  OPT_fopenmp_simd = 735,                    /* -fopenmp-simd */
  OPT_foperator_names = 736,                 /* -foperator-names */
  OPT_fopt_info = 737,                       /* -fopt-info */
  OPT_fopt_info_ = 738,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 739, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 740,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 741,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 742, */           /* -foptional-diags */
  OPT_fpack_struct = 743,                    /* -fpack-struct */
  OPT_fpack_struct_ = 744,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 745,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 746,              /* -fpcc-struct-return */
  OPT_fpch_deps = 747,                       /* -fpch-deps */
  OPT_fpch_preprocess = 748,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 749,                     /* -fpeel-loops */
  OPT_fpeephole = 750,                       /* -fpeephole */
  OPT_fpeephole2 = 751,                      /* -fpeephole2 */
  OPT_fpermissive = 752,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 753,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 754,                            /* -fpic */
  OPT_fpie = 755,                            /* -fpie */
  OPT_fplan9_extensions = 756,               /* -fplan9-extensions */
  OPT_fplt = 757,                            /* -fplt */
  OPT_fplugin_arg_ = 758,                    /* -fplugin-arg- */
  OPT_fplugin_ = 759,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 760,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 761,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 762,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 763,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 764,                   /* -fpreprocessed */
  OPT_fpretty_templates = 765,               /* -fpretty-templates */
  OPT_fprintf_return_value = 766,            /* -fprintf-return-value */
  ...
  OPT_fprofile_reorder_functions = 773,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 774,                 /* -fprofile-report */
  OPT_fprofile_update_ = 775,                /* -fprofile-update= */
  OPT_fprofile_use = 776,                    /* -fprofile-use */
  OPT_fprofile_use_ = 777,                   /* -fprofile-use= */
  OPT_fprofile_values = 778,                 /* -fprofile-values */
  OPT_frandom_seed = 779,                    /* -frandom-seed */
  OPT_frandom_seed_ = 780,                   /* -frandom-seed= */
  OPT_freciprocal_math = 781,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 782,            /* -frecord-gcc-switches */
  OPT_free = 783,                            /* -free */
  OPT_freg_struct_return = 784,              /* -freg-struct-return */
  /* OPT_fregmove = 785, */                  /* -fregmove */
  OPT_frename_registers = 786,               /* -frename-registers */
  OPT_freorder_blocks = 787,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 788,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 789,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 790,              /* -freorder-functions */
  OPT_freplace_objc_classes = 791,           /* -freplace-objc-classes */
  OPT_frepo = 792,                           /* -frepo */
  OPT_freport_bug = 793,                     /* -freport-bug */
  OPT_frerun_cse_after_loop = 794,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 795, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 796,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 797,                    /* -fresolution= */
  OPT_frounding_math = 798,                  /* -frounding-math */
  OPT_frtti = 799,                           /* -frtti */
  OPT_fsanitize_address_use_after_scope = 800,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_trace_pc = 801,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 802,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 803,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 804,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 805,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 806,                      /* -fsanitize= */
  OPT_fsched_critical_path_heuristic = 807,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 808,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 809,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 810,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 811,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 812,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 813,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 814,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 815,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 816,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 817,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 818,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 819,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 820,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 821,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 822,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 823,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 824, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 825,                /* -fschedule-fusion */
  OPT_fschedule_insns = 826,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 827,                /* -fschedule-insns2 */
  OPT_fsection_anchors = 828,                /* -fsection-anchors */
  /* OPT_fsee = 829, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 830,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 831,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 832, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 833,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 834,          /* -fselective-scheduling2 */
  OPT_fself_test_ = 835,                     /* -fself-test= */
  OPT_fsemantic_interposition = 836,         /* -fsemantic-interposition */
  OPT_fshort_enums = 837,                    /* -fshort-enums */
  OPT_fshort_wchar = 838,                    /* -fshort-wchar */
  OPT_fshow_column = 839,                    /* -fshow-column */
  OPT_fshrink_wrap = 840,                    /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 841,           /* -fshrink-wrap-separate */
  OPT_fsignaling_nans = 842,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 843,               /* -fsigned-bitfields */
  OPT_fsigned_char = 844,                    /* -fsigned-char */
  OPT_fsigned_zeros = 845,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 846,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 847,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 848,             /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 849,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 850,                    /* -fsplit-loops */
  OPT_fsplit_paths = 851,                    /* -fsplit-paths */
  OPT_fsplit_stack = 852,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 853,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 854, */                 /* -fsquangle */
  OPT_fssa_backprop = 855,                   /* -fssa-backprop */
  OPT_fssa_phiopt = 856,                     /* -fssa-phiopt */
  OPT_fsso_struct_ = 857,                    /* -fsso-struct= */
  /* OPT_fstack_check = 858, */              /* -fstack-check */
  OPT_fstack_check_ = 859,                   /* -fstack-check= */
  OPT_fstack_limit = 860,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 861,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 862,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 863,                /* -fstack-protector */
  OPT_fstack_protector_all = 864,            /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 865,       /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 866,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 867,                   /* -fstack-reuse= */
  OPT_fstack_usage = 868,                    /* -fstack-usage */
  OPT_fstats = 869,                          /* -fstats */
  OPT_fstdarg_opt = 870,                     /* -fstdarg-opt */
  OPT_fstore_merging = 871,                  /* -fstore-merging */
  ...
  /* OPT_fstrong_eval_order = 878, */        /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 879,             /* -fstrong-eval-order= */
  OPT_fsync_libcalls = 880,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 881,                    /* -fsyntax-only */
  OPT_ftabstop_ = 882,                       /* -ftabstop= */
  /* OPT_ftarget_help = 883, */              /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 884,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 885, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 886,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 887,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 888, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 889,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 890,             /* -fthreadsafe-statics */
  OPT_ftime_report = 891,                    /* -ftime-report */
  OPT_ftime_report_details = 892,            /* -ftime-report-details */
  OPT_ftls_model_ = 893,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 894,               /* -ftoplevel-reorder */
  OPT_ftracer = 895,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 896,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 897,         /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 898,                    /* -ftrampolines */
  OPT_ftrapping_math = 899,                  /* -ftrapping-math */
  OPT_ftrapv = 900,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 901,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 902,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 903,                       /* -ftree-ccp */
  OPT_ftree_ch = 904,                        /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 905, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 906,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 907,                 /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 908, */          /* -ftree-copyrename */
  OPT_ftree_cselim = 909,                    /* -ftree-cselim */
  OPT_ftree_dce = 910,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 911,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 912,                       /* -ftree-dse */
  OPT_ftree_forwprop = 913,                  /* -ftree-forwprop */
  OPT_ftree_fre = 914,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 915,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 916,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 917,           /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 918, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 919,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 920,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 921, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 922,             /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 923,            /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 924,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 925,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 926,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 927,                   /* -ftree-phiprop */
  OPT_ftree_pre = 928,                       /* -ftree-pre */
  OPT_ftree_pta = 929,                       /* -ftree-pta */
  OPT_ftree_reassoc = 930,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 931, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 932,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 933,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 934,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 935,                      /* -ftree-slsr */
  OPT_ftree_sra = 936,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 937, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 938, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 939,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 940,                /* -ftree-tail-merge */
  OPT_ftree_ter = 941,                       /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 942, */   /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 943,                 /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 944, */ /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 945,                       /* -ftree-vrp */
  OPT_funconstrained_commons = 946,          /* -funconstrained-commons */
  OPT_funit_at_a_time = 947,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 948,               /* -funroll-all-loops */
  OPT_funroll_loops = 949,                   /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 950, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 951,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 952,             /* -funsigned-bitfields */
  OPT_funsigned_char = 953,                  /* -funsigned-char */
  OPT_funswitch_loops = 954,                 /* -funswitch-loops */
  OPT_funwind_tables = 955,                  /* -funwind-tables */
  OPT_fuse_cxa_atexit = 956,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 957,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 958,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 959,                    /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 960,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 961,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 962,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 963,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 964,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 965, /* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 966, */          /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 967,               /* -fvect-cost-model= */
  OPT_fverbose_asm = 968,                    /* -fverbose-asm */
  /* OPT_fversion = 969, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 970,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 971,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 972,                    /* -fvisibility= */
  OPT_fvpt = 973,                            /* -fvpt */
  /* OPT_fvtable_gc = 974, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 975, */            /* -fvtable-thunks */
  OPT_fvtable_verify_ = 976,                 /* -fvtable-verify= */
  OPT_fvtv_counts = 977,                     /* -fvtv-counts */
  OPT_fvtv_debug = 978,                      /* -fvtv-debug */
  OPT_fweak = 979,                           /* -fweak */
  OPT_fweb = 980,                            /* -fweb */
  OPT_fwhole_program = 981,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 982,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 983,              /* -fworking-directory */
  OPT_fwpa = 984,                            /* -fwpa */
  OPT_fwpa_ = 985,                           /* -fwpa= */
  OPT_fwrapv = 986,                          /* -fwrapv */
  /* OPT_fxref = 987, */                     /* -fxref */
  /* OPT_fzee = 988, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 989,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 990,                      /* -fzero-link */
  OPT_g = 991,                               /* -g */
  OPT_gcoff = 992,                           /* -gcoff */
  OPT_gcolumn_info = 993,                    /* -gcolumn-info */
  OPT_gdwarf = 994,                          /* -gdwarf */
  OPT_gdwarf_ = 995,                         /* -gdwarf- */
  OPT_gen_decls = 996,                       /* -gen-decls */
  OPT_ggdb = 997,                            /* -ggdb */
  OPT_ggnu_pubnames = 998,                   /* -ggnu-pubnames */
  OPT_gno_column_info = 999,                 /* -gno-column-info */
  OPT_gno_pubnames = 1000,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1001,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1002,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1003,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1004,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1005,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1006,                   /* -gsplit-dwarf */
  OPT_gstabs = 1007,                         /* -gstabs */
  OPT_gstabs_ = 1008,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1009,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1010,                        /* -gtoggle */
  OPT_gvms = 1011,                           /* -gvms */
  OPT_gxcoff = 1012,                         /* -gxcoff */
  OPT_gxcoff_ = 1013,                        /* -gxcoff+ */
  OPT_gz = 1014,                             /* -gz */
  OPT_gz_ = 1015,                            /* -gz= */
  OPT_h = 1016,                              /* -h */
  OPT_idirafter = 1017,                      /* -idirafter */
  OPT_imacros = 1018,                        /* -imacros */
  OPT_imultiarch = 1019,                     /* -imultiarch */
  OPT_imultilib = 1020,                      /* -imultilib */
  OPT_include = 1021,                        /* -include */
  OPT_iplugindir_ = 1022,                    /* -iplugindir= */
  OPT_iprefix = 1023,                        /* -iprefix */
  OPT_iquote = 1024,                         /* -iquote */
  OPT_iremap = 1025,                         /* -iremap */
  ...
  OPT_l = 1030,                              /* -l */
  OPT_lang_asm = 1031,                       /* -lang-asm */
  OPT_m128bit_long_double = 1032,            /* -m128bit-long-double */
  OPT_m16 = 1033,                            /* -m16 */
  OPT_m32 = 1034,                            /* -m32 */
  OPT_m3dnow = 1035,                         /* -m3dnow */
  OPT_m3dnowa = 1036,                        /* -m3dnowa */
  OPT_m64 = 1037,                            /* -m64 */
  OPT_m80387 = 1038,                         /* -m80387 */
  OPT_m8bit_idiv = 1039,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1040,             /* -m96bit-long-double */
  OPT_mabi_ = 1041,                          /* -mabi= */
  OPT_mabm = 1042,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1043,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1044,                 /* -maddress-mode= */
  OPT_madx = 1045,                           /* -madx */
  OPT_maes = 1046,                           /* -maes */
  OPT_malign_data_ = 1047,                   /* -malign-data= */
  OPT_malign_double = 1048,                  /* -malign-double */
  OPT_malign_functions_ = 1049,              /* -malign-functions= */
  OPT_malign_jumps_ = 1050,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1051,                  /* -malign-loops= */
  OPT_malign_stringops = 1052,               /* -malign-stringops */
  OPT_march_ = 1053,                         /* -march= */
  OPT_masm_ = 1054,                          /* -masm= */
  OPT_mavx = 1055,                           /* -mavx */
  OPT_mavx2 = 1056,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1057,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1058,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1059,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1060,                  /* -mavx5124vnniw */
  OPT_mavx512bw = 1061,                      /* -mavx512bw */
  OPT_mavx512cd = 1062,                      /* -mavx512cd */
  OPT_mavx512dq = 1063,                      /* -mavx512dq */
  OPT_mavx512er = 1064,                      /* -mavx512er */
  OPT_mavx512f = 1065,                       /* -mavx512f */
  OPT_mavx512ifma = 1066,                    /* -mavx512ifma */
  OPT_mavx512pf = 1067,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1068,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1069,                      /* -mavx512vl */
  OPT_mavx512vpopcntdq = 1070,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1071,                           /* -mbmi */
  OPT_mbmi2 = 1072,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1073,                  /* -mbranch-cost= */
  OPT_mcld = 1074,                           /* -mcld */
  OPT_mclflushopt = 1075,                    /* -mclflushopt */
  OPT_mclwb = 1076,                          /* -mclwb */
  OPT_mclzero = 1077,                        /* -mclzero */
  OPT_mcmodel_ = 1078,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1079, */                    /* -mcpu= */
  OPT_mcrc32 = 1080,                         /* -mcrc32 */
  OPT_mcx16 = 1081,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1082,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1083,            /* -mdump-tune-features */
  OPT_mf16c = 1084,                          /* -mf16c */
  OPT_mfancy_math_387 = 1085,                /* -mfancy-math-387 */
  OPT_mfentry = 1086,                        /* -mfentry */
  OPT_mfma = 1087,                           /* -mfma */
  OPT_mfma4 = 1088,                          /* -mfma4 */
  OPT_mforce_drap = 1089,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1090,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1091,                       /* -mfpmath= */
  OPT_mfsgsbase = 1092,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1093,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1094, */              /* -mfused-madd */
  OPT_mfxsr = 1095,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1096,             /* -mgeneral-regs-only */
  OPT_mhard_float = 1097,                    /* -mhard-float */
  OPT_mhle = 1098,                           /* -mhle */
  OPT_miamcu = 1099,                         /* -miamcu */
  OPT_mieee_fp = 1100,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1101,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1102,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1103,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1104,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1105,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1106, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1107,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1108,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1109,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1110,                /* -mlong-double-80 */
  OPT_mlwp = 1111,                           /* -mlwp */
  OPT_mlzcnt = 1112,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1113,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1114,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1115,                  /* -mmitigate-rop */
  OPT_mmmx = 1116,                           /* -mmmx */
  OPT_mmovbe = 1117,                         /* -mmovbe */
  OPT_mmpx = 1118,                           /* -mmpx */
  OPT_mms_bitfields = 1119,                  /* -mms-bitfields */
  OPT_mmwaitx = 1120,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1121,            /* -mno-align-stringops */
  OPT_mno_default = 1122,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1123,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1124,                  /* -mno-push-args */
  OPT_mno_red_zone = 1125,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1126,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1127,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1128,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1129,                          /* -mpc32 */
  OPT_mpc64 = 1130,                          /* -mpc64 */
  OPT_mpc80 = 1131,                          /* -mpc80 */
  OPT_mpclmul = 1132,                        /* -mpclmul */
  OPT_mpcommit = 1133,                       /* -mpcommit */
  OPT_mpku = 1134,                           /* -mpku */
  OPT_mpopcnt = 1135,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1136,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1137,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1138,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1139,                        /* -mprfchw */
  OPT_mpush_args = 1140,                     /* -mpush-args */
  OPT_mrdpid = 1141,                         /* -mrdpid */
  OPT_mrdrnd = 1142,                         /* -mrdrnd */
  OPT_mrdseed = 1143,                        /* -mrdseed */
  OPT_mrecip = 1144,                         /* -mrecip */
  OPT_mrecip_ = 1145,                        /* -mrecip= */
  OPT_mrecord_mcount = 1146,                 /* -mrecord-mcount */
  OPT_mred_zone = 1147,                      /* -mred-zone */
  OPT_mregparm_ = 1148,                      /* -mregparm= */
  OPT_mrtd = 1149,                           /* -mrtd */
  OPT_mrtm = 1150,                           /* -mrtm */
  OPT_msahf = 1151,                          /* -msahf */
  OPT_msgx = 1152,                           /* -msgx */
  OPT_msha = 1153,                           /* -msha */
  OPT_mskip_rax_setup = 1154,                /* -mskip-rax-setup */
  OPT_msoft_float = 1155,                    /* -msoft-float */
  OPT_msse = 1156,                           /* -msse */
  OPT_msse2 = 1157,                          /* -msse2 */
  OPT_msse2avx = 1158,                       /* -msse2avx */
  OPT_msse3 = 1159,                          /* -msse3 */
  OPT_msse4 = 1160,                          /* -msse4 */
  OPT_msse4_1 = 1161,                        /* -msse4.1 */
  OPT_msse4_2 = 1162,                        /* -msse4.2 */
  OPT_msse4a = 1163,                         /* -msse4a */
  /* OPT_msse5 = 1164, */                    /* -msse5 */
  OPT_msseregparm = 1165,                    /* -msseregparm */
  OPT_mssse3 = 1166,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1167,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1168,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1169,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1170,            /* -mstringop-strategy= */
  OPT_mstv = 1171,                           /* -mstv */
  OPT_mtbm = 1172,                           /* -mtbm */
  OPT_mtls_dialect_ = 1173,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1174,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1175,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1176,                         /* -mtune= */
  OPT_mveclibabi_ = 1177,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1178,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1179,                    /* -mvzeroupper */
  OPT_mx32 = 1180,                           /* -mx32 */
  OPT_mxop = 1181,                           /* -mxop */
  OPT_mxsave = 1182,                         /* -mxsave */
  OPT_mxsavec = 1183,                        /* -mxsavec */
  OPT_mxsaveopt = 1184,                      /* -mxsaveopt */
  OPT_mxsaves = 1185,                        /* -mxsaves */
  OPT_n = 1186,                              /* -n */
  ...
  OPT_static_libmpx = 1234,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1235,          /* -static-libmpxwrappers */
  ...
  /* OPT_std_c__17 = 1243, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1244, */                /* -std=c++1y */
  OPT_std_c__1z = 1245,                      /* -std=c++1z */
  OPT_std_c__98 = 1246,                      /* -std=c++98 */
  OPT_std_c11 = 1247,                        /* -std=c11 */
  /* OPT_std_c1x = 1248, */                  /* -std=c1x */
  /* OPT_std_c89 = 1249, */                  /* -std=c89 */
  OPT_std_c90 = 1250,                        /* -std=c90 */
  OPT_std_c99 = 1251,                        /* -std=c99 */
  /* OPT_std_c9x = 1252, */                  /* -std=c9x */
