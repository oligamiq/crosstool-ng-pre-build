...
__BEGIN_DECLS
bool_t xdr_rexstring(XDR *, rexstring *);
bool_t xdr_rex_start(XDR *, rex_start *);
bool_t xdr_rex_result(XDR *, rex_result *);
bool_t xdr_sgttyb(XDR *, sgttyb *);
bool_t xdr_tchars(XDR *, tchars *);
bool_t xdr_ltchars(XDR *, ltchars *);
bool_t xdr_rex_ttysize(XDR *, rex_ttysize *);
...
__BEGIN_DECLS
rex_result *rexproc_start_1(rex_start *, CLIENT *);
rex_result *rexproc_start_1_svc(rex_start *, struct svc_req *);
rex_result *rexproc_wait_1(void *, CLIENT *);
rex_result *rexproc_wait_1_svc(void *, struct svc_req *);
void *rexproc_modes_1(rex_ttymode *, CLIENT *);
void *rexproc_modes_1_svc(rex_ttymode *, struct svc_req *);
void *rexproc_winch_1(rex_ttysize *, CLIENT *);
void *rexproc_winch_1_svc(rex_ttysize *, struct svc_req *);
void *rexproc_signal_1(int *, CLIENT *);
void *rexproc_signal_1_svc(int *, struct svc_req *);
__END_DECLS
